...
export type GovernedEvidenceRecommendationStrengthEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEvidenceRecommendationStrengthEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEvidenceRecommendationStrengthEngineEntryView[];
