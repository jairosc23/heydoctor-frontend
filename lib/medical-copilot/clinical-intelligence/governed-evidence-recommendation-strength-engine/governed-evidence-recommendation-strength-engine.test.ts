...
describe("Evidence Recommendation Strength Engine", () => {
  it("maps envelope with evidence entries and HITL seals", () => {
    const mapped = mapGovernedEvidenceRecommendationStrengthEngineEnvelope({
      status: "ok",
      data: {
        status: "PROPOSED_FOR_PHYSICIAN_REVIEW",
        title: "Evidence Recommendation Strength Engine",
        applicableCount: 1,
        entries: [{
          entryId: "e1",
          entryTitle: "Entry",
          domain: "evidence_recommendation_strength",
          topic: "t",
          summary: "s",
          explanation: "x",
