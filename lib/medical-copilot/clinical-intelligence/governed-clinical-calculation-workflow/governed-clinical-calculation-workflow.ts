...
export type GovernedClinicalCalculationWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalCalculationWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalCalculationWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
