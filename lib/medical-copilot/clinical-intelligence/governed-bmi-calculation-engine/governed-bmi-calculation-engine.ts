...
export type GovernedBmiCalculationEngineEntryView = {
...
export type GovernedBmiCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedBmiCalculationEngineEntryView[]; enginesPresent: string[];
