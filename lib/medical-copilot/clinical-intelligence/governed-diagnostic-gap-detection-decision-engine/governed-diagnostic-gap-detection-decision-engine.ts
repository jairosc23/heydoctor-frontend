...
export type GovernedDiagnosticGapDetectionEngineEntryView = {
...
export type GovernedDiagnosticGapDetectionEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticGapDetectionEngineEntryView[]; enginesPresent: string[];
