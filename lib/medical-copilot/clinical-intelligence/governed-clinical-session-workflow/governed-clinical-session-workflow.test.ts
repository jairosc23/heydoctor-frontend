...
describe("Clinical Session Workflow", () => {
  it("maps workflow envelope with stages and HITL seals", () => {
    const mapped = mapGovernedClinicalSessionWorkflowEnvelope({ status: "ok", data: {
      status: "READY_FOR_PHYSICIAN_REVIEW",
      title: "Clinical Session Workflow",
      workflowId: "e2e_wf_1",
    ...
    assert.equal(mapped.workflowType, "clinical_session_workflow");
