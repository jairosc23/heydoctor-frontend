...
export type GovernedOttawaAnkleRulesCalculationEngineEntryView = {
...
export type GovernedOttawaAnkleRulesCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedOttawaAnkleRulesCalculationEngineEntryView[]; enginesPresent: string[];
