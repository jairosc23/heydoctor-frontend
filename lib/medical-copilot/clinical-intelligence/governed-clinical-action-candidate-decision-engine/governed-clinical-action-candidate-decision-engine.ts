...
export type GovernedClinicalActionCandidateEngineEntryView = {
...
export type GovernedClinicalActionCandidateEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalActionCandidateEngineEntryView[]; enginesPresent: string[];
