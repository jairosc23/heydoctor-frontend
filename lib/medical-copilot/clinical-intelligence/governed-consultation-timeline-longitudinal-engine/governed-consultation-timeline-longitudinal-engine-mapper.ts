import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedConsultationTimelineLongitudinalEngineEntryView, type GovernedConsultationTimelineLongitudinalEngineResult } from "./governed-consultation-timeline-longitudinal-engine";
function mapEntry(raw: unknown): GovernedConsultationTimelineLongitudinalEngineEntryView | null {
...
export function mapGovernedConsultationTimelineLongitudinalEngineEnvelope(payload: unknown): GovernedConsultationTimelineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedConsultationTimelineLongitudinalEngineEntryView => e !== null);
