import {
  ...
  type GovernedConsultationPersistenceBridgeComponentKey,
  type GovernedConsultationPersistenceBridgeComponentPresence,
  type GovernedConsultationPersistenceBridgeResult,
...
export function mapGovernedConsultationPersistenceBridgeEnvelope(
  payload: unknown,
): GovernedConsultationPersistenceBridgeResult | null {
  ...
  const components: GovernedConsultationPersistenceBridgeComponentPresence[] =
