...
export type GovernedDiagnosticAlertsDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticAlertsDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticAlertsDiagnosticIntelEngineEntryView[];
