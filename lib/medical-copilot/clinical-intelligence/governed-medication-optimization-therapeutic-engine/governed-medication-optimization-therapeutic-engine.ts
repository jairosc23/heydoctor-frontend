...
export type GovernedMedicationOptimizationTherapeuticEngineEntryView = {
...
export type GovernedMedicationOptimizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMedicationOptimizationTherapeuticEngineEntryView[];
