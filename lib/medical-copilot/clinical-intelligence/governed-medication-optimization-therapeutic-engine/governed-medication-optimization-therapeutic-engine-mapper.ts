import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedMedicationOptimizationTherapeuticEngineEntryView, type GovernedMedicationOptimizationTherapeuticEngineResult } from "./governed-medication-optimization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedMedicationOptimizationTherapeuticEngineEntryView | null {
...
export function mapGovernedMedicationOptimizationTherapeuticEngineEnvelope(payload: unknown): GovernedMedicationOptimizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedMedicationOptimizationTherapeuticEngineEntryView => e !== null);
