...
describe("Medication Optimization", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedMedicationOptimizationTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Medication Optimization", applicableCount: 1,
