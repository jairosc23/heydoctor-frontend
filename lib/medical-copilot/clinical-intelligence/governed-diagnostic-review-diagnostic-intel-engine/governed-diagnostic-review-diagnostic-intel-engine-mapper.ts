import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticReviewDiagnosticIntelEngineEntryView, type GovernedDiagnosticReviewDiagnosticIntelEngineResult } from "./governed-diagnostic-review-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticReviewDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticReviewDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticReviewDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticReviewDiagnosticIntelEngineEntryView => e !== null);
