...
export type GovernedDiagnosticReviewDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticReviewDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticReviewDiagnosticIntelEngineEntryView[];
