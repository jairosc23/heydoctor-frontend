...
describe("Diagnostic Review", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticReviewDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Review", applicableCount: 1,
