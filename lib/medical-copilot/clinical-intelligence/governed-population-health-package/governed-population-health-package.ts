...
export type GovernedPopulationHealthPackageEntryView = {
...
export type GovernedPopulationHealthPackageResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationHealthPackageEntryView[];
