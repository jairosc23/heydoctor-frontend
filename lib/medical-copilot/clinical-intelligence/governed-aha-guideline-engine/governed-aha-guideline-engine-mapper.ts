import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAhaGuidelineEngineEntryView, type GovernedAhaGuidelineEngineResult } from "./governed-aha-guideline-engine";

function mapEntry(raw: unknown): GovernedAhaGuidelineEngineEntryView | null {
...
export function mapGovernedAhaGuidelineEngineEnvelope(payload: unknown): GovernedAhaGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAhaGuidelineEngineEntryView => e !== null);
