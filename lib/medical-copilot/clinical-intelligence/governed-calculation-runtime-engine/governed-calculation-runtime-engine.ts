...
export type GovernedCalculationRuntimeEngineEntryView = {
...
export type GovernedCalculationRuntimeEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCalculationRuntimeEngineEntryView[]; enginesPresent: string[];
