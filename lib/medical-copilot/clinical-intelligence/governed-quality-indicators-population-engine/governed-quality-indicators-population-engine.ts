...
export type GovernedQualityIndicatorsPopulationEngineEntryView = {
...
export type GovernedQualityIndicatorsPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedQualityIndicatorsPopulationEngineEntryView[];
