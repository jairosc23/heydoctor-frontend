import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedVaccinationTimelineLongitudinalEngineEntryView, type GovernedVaccinationTimelineLongitudinalEngineResult } from "./governed-vaccination-timeline-longitudinal-engine";
function mapEntry(raw: unknown): GovernedVaccinationTimelineLongitudinalEngineEntryView | null {
...
export function mapGovernedVaccinationTimelineLongitudinalEngineEnvelope(payload: unknown): GovernedVaccinationTimelineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedVaccinationTimelineLongitudinalEngineEntryView => e !== null);
