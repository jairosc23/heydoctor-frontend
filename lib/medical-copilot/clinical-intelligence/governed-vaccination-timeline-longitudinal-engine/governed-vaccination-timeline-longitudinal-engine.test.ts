...
describe("Vaccination Timeline", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedVaccinationTimelineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Vaccination Timeline", applicableCount: 1,
