...
export type GovernedVaccinationTimelineLongitudinalEngineEntryView = {
...
export type GovernedVaccinationTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedVaccinationTimelineLongitudinalEngineEntryView[];
