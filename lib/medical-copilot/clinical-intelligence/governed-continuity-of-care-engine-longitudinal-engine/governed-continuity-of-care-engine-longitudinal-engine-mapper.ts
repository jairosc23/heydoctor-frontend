import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedContinuityOfCareEngineLongitudinalEngineEntryView, type GovernedContinuityOfCareEngineLongitudinalEngineResult } from "./governed-continuity-of-care-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedContinuityOfCareEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedContinuityOfCareEngineLongitudinalEngineEnvelope(payload: unknown): GovernedContinuityOfCareEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedContinuityOfCareEngineLongitudinalEngineEntryView => e !== null);
