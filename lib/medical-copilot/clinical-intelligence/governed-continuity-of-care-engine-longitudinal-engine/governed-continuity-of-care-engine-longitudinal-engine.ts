...
export type GovernedContinuityOfCareEngineLongitudinalEngineEntryView = {
...
export type GovernedContinuityOfCareEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedContinuityOfCareEngineLongitudinalEngineEntryView[];
