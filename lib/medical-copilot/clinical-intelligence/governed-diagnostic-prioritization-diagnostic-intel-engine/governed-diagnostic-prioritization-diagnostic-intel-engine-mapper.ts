import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticPrioritizationDiagnosticIntelEngineEntryView, type GovernedDiagnosticPrioritizationDiagnosticIntelEngineResult } from "./governed-diagnostic-prioritization-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticPrioritizationDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticPrioritizationDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticPrioritizationDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticPrioritizationDiagnosticIntelEngineEntryView => e !== null);
