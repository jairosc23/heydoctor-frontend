...
export type GovernedDiagnosticPrioritizationDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticPrioritizationDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticPrioritizationDiagnosticIntelEngineEntryView[];
