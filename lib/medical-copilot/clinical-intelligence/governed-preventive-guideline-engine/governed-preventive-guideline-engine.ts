...
export type GovernedPreventiveGuidelineEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedPreventiveGuidelineEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedPreventiveGuidelineEngineEntryView[];
