...
export type GovernedClinicalCoherenceEngineEntryView = {
...
export type GovernedClinicalCoherenceEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalCoherenceEngineEntryView[]; enginesPresent: string[];
