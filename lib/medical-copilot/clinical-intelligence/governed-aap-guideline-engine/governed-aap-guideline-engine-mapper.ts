import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAapGuidelineEngineEntryView, type GovernedAapGuidelineEngineResult } from "./governed-aap-guideline-engine";

function mapEntry(raw: unknown): GovernedAapGuidelineEngineEntryView | null {
...
export function mapGovernedAapGuidelineEngineEnvelope(payload: unknown): GovernedAapGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAapGuidelineEngineEntryView => e !== null);
