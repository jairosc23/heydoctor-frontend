import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedEscEvidenceEngineEntryView, type GovernedEscEvidenceEngineResult } from "./governed-esc-evidence-engine";

function mapEntry(raw: unknown): GovernedEscEvidenceEngineEntryView | null {
...
export function mapGovernedEscEvidenceEngineEnvelope(payload: unknown): GovernedEscEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedEscEvidenceEngineEntryView => e !== null);
