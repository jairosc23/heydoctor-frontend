import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedCarePathwayOptimizationTherapeuticEngineEntryView, type GovernedCarePathwayOptimizationTherapeuticEngineResult } from "./governed-care-pathway-optimization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedCarePathwayOptimizationTherapeuticEngineEntryView | null {
...
export function mapGovernedCarePathwayOptimizationTherapeuticEngineEnvelope(payload: unknown): GovernedCarePathwayOptimizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedCarePathwayOptimizationTherapeuticEngineEntryView => e !== null);
