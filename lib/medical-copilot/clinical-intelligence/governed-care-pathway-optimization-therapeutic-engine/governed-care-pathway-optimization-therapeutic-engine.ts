...
export type GovernedCarePathwayOptimizationTherapeuticEngineEntryView = {
...
export type GovernedCarePathwayOptimizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCarePathwayOptimizationTherapeuticEngineEntryView[];
