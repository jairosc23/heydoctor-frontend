...
describe("GovernedContraindicationRuleEngine mapper", () => {
  it("maps deterministic rule evaluations with explainability fields", () => {
    const mapped = mapGovernedContraindicationRuleEngineEnvelope({
    ...
    assert.equal(mapGovernedContraindicationRuleEngineEnvelope(null), null);
  });
});
