...
export type GovernedDiagnosticCorrelationDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticCorrelationDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticCorrelationDiagnosticIntelEngineEntryView[];
