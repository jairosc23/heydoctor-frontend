import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticCorrelationDiagnosticIntelEngineEntryView, type GovernedDiagnosticCorrelationDiagnosticIntelEngineResult } from "./governed-diagnostic-correlation-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticCorrelationDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticCorrelationDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticCorrelationDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticCorrelationDiagnosticIntelEngineEntryView => e !== null);
