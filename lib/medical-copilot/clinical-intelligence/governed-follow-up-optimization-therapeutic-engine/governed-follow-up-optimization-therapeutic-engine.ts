...
export type GovernedFollowUpOptimizationTherapeuticEngineEntryView = {
...
export type GovernedFollowUpOptimizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedFollowUpOptimizationTherapeuticEngineEntryView[];
