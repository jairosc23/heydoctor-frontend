import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedFollowUpOptimizationTherapeuticEngineEntryView, type GovernedFollowUpOptimizationTherapeuticEngineResult } from "./governed-follow-up-optimization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedFollowUpOptimizationTherapeuticEngineEntryView | null {
...
export function mapGovernedFollowUpOptimizationTherapeuticEngineEnvelope(payload: unknown): GovernedFollowUpOptimizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedFollowUpOptimizationTherapeuticEngineEntryView => e !== null);
