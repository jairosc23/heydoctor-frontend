...
export type GovernedSurvivingSepsisGuidelineEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedSurvivingSepsisGuidelineEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedSurvivingSepsisGuidelineEngineEntryView[];
