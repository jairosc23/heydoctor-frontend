import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedClinicalEvolutionEngineLongitudinalEngineEntryView, type GovernedClinicalEvolutionEngineLongitudinalEngineResult } from "./governed-clinical-evolution-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedClinicalEvolutionEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedClinicalEvolutionEngineLongitudinalEngineEnvelope(payload: unknown): GovernedClinicalEvolutionEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalEvolutionEngineLongitudinalEngineEntryView => e !== null);
