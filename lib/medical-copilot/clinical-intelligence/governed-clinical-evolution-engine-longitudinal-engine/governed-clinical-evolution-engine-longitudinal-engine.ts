...
export type GovernedClinicalEvolutionEngineLongitudinalEngineEntryView = {
...
export type GovernedClinicalEvolutionEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalEvolutionEngineLongitudinalEngineEntryView[];
