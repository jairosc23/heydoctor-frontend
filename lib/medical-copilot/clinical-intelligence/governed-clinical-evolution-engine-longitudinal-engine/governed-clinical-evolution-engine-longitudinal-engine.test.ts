...
describe("Clinical Evolution Engine", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedClinicalEvolutionEngineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Clinical Evolution Engine", applicableCount: 1,
