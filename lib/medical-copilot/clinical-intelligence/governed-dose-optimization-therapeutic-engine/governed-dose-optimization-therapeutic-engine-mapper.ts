import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDoseOptimizationTherapeuticEngineEntryView, type GovernedDoseOptimizationTherapeuticEngineResult } from "./governed-dose-optimization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedDoseOptimizationTherapeuticEngineEntryView | null {
...
export function mapGovernedDoseOptimizationTherapeuticEngineEnvelope(payload: unknown): GovernedDoseOptimizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDoseOptimizationTherapeuticEngineEntryView => e !== null);
