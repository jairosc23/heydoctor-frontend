...
export type GovernedDoseOptimizationTherapeuticEngineEntryView = {
...
export type GovernedDoseOptimizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDoseOptimizationTherapeuticEngineEntryView[];
