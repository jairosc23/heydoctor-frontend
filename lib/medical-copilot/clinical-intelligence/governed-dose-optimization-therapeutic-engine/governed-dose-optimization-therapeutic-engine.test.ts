...
describe("Dose Optimization", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDoseOptimizationTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Dose Optimization", applicableCount: 1,
