...
export type GovernedTimiCalculationEngineEntryView = {
...
export type GovernedTimiCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTimiCalculationEngineEntryView[]; enginesPresent: string[];
