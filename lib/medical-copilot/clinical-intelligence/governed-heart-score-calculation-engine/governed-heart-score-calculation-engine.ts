...
export type GovernedHeartScoreCalculationEngineEntryView = {
...
export type GovernedHeartScoreCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedHeartScoreCalculationEngineEntryView[]; enginesPresent: string[];
