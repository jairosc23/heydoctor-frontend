import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedEscGuidelineEngineEntryView, type GovernedEscGuidelineEngineResult } from "./governed-esc-guideline-engine";

function mapEntry(raw: unknown): GovernedEscGuidelineEngineEntryView | null {
...
export function mapGovernedEscGuidelineEngineEnvelope(payload: unknown): GovernedEscGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedEscGuidelineEngineEntryView => e !== null);
