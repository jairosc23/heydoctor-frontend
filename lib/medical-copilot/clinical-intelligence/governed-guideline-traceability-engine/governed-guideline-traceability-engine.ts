...
export type GovernedGuidelineTraceabilityEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedGuidelineTraceabilityEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedGuidelineTraceabilityEngineEntryView[];
