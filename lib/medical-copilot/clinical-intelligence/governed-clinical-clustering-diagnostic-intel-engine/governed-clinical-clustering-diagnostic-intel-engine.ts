...
export type GovernedClinicalClusteringDiagnosticIntelEngineEntryView = {
...
export type GovernedClinicalClusteringDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalClusteringDiagnosticIntelEngineEntryView[];
