...
export type GovernedClinicalContextAggregatorRefView = {
...
export type GovernedOrchestratorAggregatorView = {
  ...
  surfaceRefs: GovernedClinicalContextAggregatorRefView[];
};
export type GovernedClinicalContextAggregatorResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
