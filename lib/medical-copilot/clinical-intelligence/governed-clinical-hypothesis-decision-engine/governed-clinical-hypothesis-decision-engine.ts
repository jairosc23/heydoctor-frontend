...
export type GovernedClinicalHypothesisEngineEntryView = {
...
export type GovernedClinicalHypothesisEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalHypothesisEngineEntryView[]; enginesPresent: string[];
