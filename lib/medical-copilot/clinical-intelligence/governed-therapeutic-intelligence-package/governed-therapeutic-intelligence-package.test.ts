...
describe("Therapeutic Intelligence Package", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedTherapeuticIntelligencePackageEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Therapeutic Intelligence Package", applicableCount: 1,
