import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTherapeuticIntelligencePackageEntryView, type GovernedTherapeuticIntelligencePackageResult } from "./governed-therapeutic-intelligence-package";
function mapEntry(raw: unknown): GovernedTherapeuticIntelligencePackageEntryView | null {
...
export function mapGovernedTherapeuticIntelligencePackageEnvelope(payload: unknown): GovernedTherapeuticIntelligencePackageResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTherapeuticIntelligencePackageEntryView => e !== null);
