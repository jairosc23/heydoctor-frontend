...
describe("Diagnostic Validation", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticValidationDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Validation", applicableCount: 1,
