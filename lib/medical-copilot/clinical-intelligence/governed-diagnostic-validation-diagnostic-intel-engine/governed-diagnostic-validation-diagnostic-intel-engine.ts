...
export type GovernedDiagnosticValidationDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticValidationDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticValidationDiagnosticIntelEngineEntryView[];
