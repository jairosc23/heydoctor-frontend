...
export type GovernedExpertConsensusEvidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedExpertConsensusEvidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedExpertConsensusEvidenceEngineEntryView[];
