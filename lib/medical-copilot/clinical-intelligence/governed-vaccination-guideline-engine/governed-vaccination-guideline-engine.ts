...
export type GovernedVaccinationGuidelineEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedVaccinationGuidelineEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedVaccinationGuidelineEngineEntryView[];
