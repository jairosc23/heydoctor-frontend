import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedPolypharmacyOptimizationTherapeuticEngineEntryView, type GovernedPolypharmacyOptimizationTherapeuticEngineResult } from "./governed-polypharmacy-optimization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedPolypharmacyOptimizationTherapeuticEngineEntryView | null {
...
export function mapGovernedPolypharmacyOptimizationTherapeuticEngineEnvelope(payload: unknown): GovernedPolypharmacyOptimizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPolypharmacyOptimizationTherapeuticEngineEntryView => e !== null);
