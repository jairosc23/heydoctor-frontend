...
export type GovernedPolypharmacyOptimizationTherapeuticEngineEntryView = {
...
export type GovernedPolypharmacyOptimizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPolypharmacyOptimizationTherapeuticEngineEntryView[];
