...
export type GovernedPreventiveScreeningKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedPreventiveScreeningKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedPreventiveScreeningKnowledgeEngineEntryView[];
