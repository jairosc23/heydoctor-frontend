import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedPreventiveScreeningKnowledgeEngineEntryView, type GovernedPreventiveScreeningKnowledgeEngineResult } from "./governed-preventive-screening-knowledge-engine";

function mapEntry(raw: unknown): GovernedPreventiveScreeningKnowledgeEngineEntryView | null {
...
export function mapGovernedPreventiveScreeningKnowledgeEngineEnvelope(payload: unknown): GovernedPreventiveScreeningKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPreventiveScreeningKnowledgeEngineEntryView => e !== null);
