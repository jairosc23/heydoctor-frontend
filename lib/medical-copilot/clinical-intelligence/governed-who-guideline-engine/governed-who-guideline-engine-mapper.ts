import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedWhoGuidelineEngineEntryView, type GovernedWhoGuidelineEngineResult } from "./governed-who-guideline-engine";

function mapEntry(raw: unknown): GovernedWhoGuidelineEngineEntryView | null {
...
export function mapGovernedWhoGuidelineEngineEnvelope(payload: unknown): GovernedWhoGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedWhoGuidelineEngineEntryView => e !== null);
