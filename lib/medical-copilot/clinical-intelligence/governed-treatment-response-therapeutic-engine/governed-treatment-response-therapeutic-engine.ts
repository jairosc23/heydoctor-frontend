...
export type GovernedTreatmentResponseTherapeuticEngineEntryView = {
...
export type GovernedTreatmentResponseTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTreatmentResponseTherapeuticEngineEntryView[];
