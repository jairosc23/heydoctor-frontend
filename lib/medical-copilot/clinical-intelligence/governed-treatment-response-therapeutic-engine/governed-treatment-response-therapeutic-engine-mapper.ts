import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTreatmentResponseTherapeuticEngineEntryView, type GovernedTreatmentResponseTherapeuticEngineResult } from "./governed-treatment-response-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTreatmentResponseTherapeuticEngineEntryView | null {
...
export function mapGovernedTreatmentResponseTherapeuticEngineEnvelope(payload: unknown): GovernedTreatmentResponseTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTreatmentResponseTherapeuticEngineEntryView => e !== null);
