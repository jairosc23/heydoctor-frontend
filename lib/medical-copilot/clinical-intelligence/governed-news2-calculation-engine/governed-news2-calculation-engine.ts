...
export type GovernedNews2CalculationEngineEntryView = {
...
export type GovernedNews2CalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedNews2CalculationEngineEntryView[]; enginesPresent: string[];
