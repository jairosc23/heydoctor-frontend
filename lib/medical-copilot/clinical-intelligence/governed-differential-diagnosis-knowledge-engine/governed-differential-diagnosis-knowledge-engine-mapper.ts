import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedDifferentialDiagnosisKnowledgeEngineEntryView, type GovernedDifferentialDiagnosisKnowledgeEngineResult } from "./governed-differential-diagnosis-knowledge-engine";

function mapEntry(raw: unknown): GovernedDifferentialDiagnosisKnowledgeEngineEntryView | null {
...
export function mapGovernedDifferentialDiagnosisKnowledgeEngineEnvelope(payload: unknown): GovernedDifferentialDiagnosisKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDifferentialDiagnosisKnowledgeEngineEntryView => e !== null);
