...
export type GovernedDifferentialDiagnosisKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedDifferentialDiagnosisKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedDifferentialDiagnosisKnowledgeEngineEntryView[];
