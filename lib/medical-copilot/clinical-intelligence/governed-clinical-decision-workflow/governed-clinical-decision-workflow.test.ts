...
describe("Clinical Decision Workflow", () => {
  it("maps workflow envelope with stages and HITL seals", () => {
    const mapped = mapGovernedClinicalDecisionWorkflowEnvelope({ status: "ok", data: {
      status: "READY_FOR_PHYSICIAN_REVIEW",
      title: "Clinical Decision Workflow",
      workflowId: "e2e_wf_1",
      workflowType: "clinical_decision_workflow",
      summary: "E2E mock",
    ...
    assert.equal(mapped.workflowType, "clinical_decision_workflow");
