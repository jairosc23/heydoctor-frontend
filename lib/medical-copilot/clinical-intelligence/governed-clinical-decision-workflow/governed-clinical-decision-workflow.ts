...
export type GovernedClinicalDecisionWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalDecisionWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalDecisionWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
