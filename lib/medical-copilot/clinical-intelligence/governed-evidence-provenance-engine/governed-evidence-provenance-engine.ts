...
export type GovernedEvidenceProvenanceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEvidenceProvenanceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEvidenceProvenanceEngineEntryView[];
