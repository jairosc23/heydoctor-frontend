...
describe("GovernedClinicalIntelligenceStage mapper", () => {
  it("maps pipeline stage without write/LLM flags", () => {
    const mapped = mapGovernedClinicalIntelligenceStageEnvelope({
    ...
    assert.equal(mapGovernedClinicalIntelligenceStageEnvelope(null), null);
  });
});
