...
describe("GovernedDrugInteractionRuleEngine mapper", () => {
  it("maps deterministic rule evaluations with explainability fields", () => {
    const mapped = mapGovernedDrugInteractionRuleEngineEnvelope({
    ...
    assert.equal(mapGovernedDrugInteractionRuleEngineEnvelope(null), null);
  });
});
