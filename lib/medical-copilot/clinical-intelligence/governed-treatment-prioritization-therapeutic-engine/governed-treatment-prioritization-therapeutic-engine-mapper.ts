import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTreatmentPrioritizationTherapeuticEngineEntryView, type GovernedTreatmentPrioritizationTherapeuticEngineResult } from "./governed-treatment-prioritization-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTreatmentPrioritizationTherapeuticEngineEntryView | null {
...
export function mapGovernedTreatmentPrioritizationTherapeuticEngineEnvelope(payload: unknown): GovernedTreatmentPrioritizationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTreatmentPrioritizationTherapeuticEngineEntryView => e !== null);
