...
export type GovernedTreatmentPrioritizationTherapeuticEngineEntryView = {
...
export type GovernedTreatmentPrioritizationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTreatmentPrioritizationTherapeuticEngineEntryView[];
