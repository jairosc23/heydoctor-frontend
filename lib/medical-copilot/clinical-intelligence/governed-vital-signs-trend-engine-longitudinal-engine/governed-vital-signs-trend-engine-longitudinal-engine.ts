...
export type GovernedVitalSignsTrendEngineLongitudinalEngineEntryView = {
...
export type GovernedVitalSignsTrendEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedVitalSignsTrendEngineLongitudinalEngineEntryView[];
