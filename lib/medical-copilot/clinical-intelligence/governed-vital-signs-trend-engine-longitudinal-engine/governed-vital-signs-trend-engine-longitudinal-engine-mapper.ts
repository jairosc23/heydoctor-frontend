import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedVitalSignsTrendEngineLongitudinalEngineEntryView, type GovernedVitalSignsTrendEngineLongitudinalEngineResult } from "./governed-vital-signs-trend-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedVitalSignsTrendEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedVitalSignsTrendEngineLongitudinalEngineEnvelope(payload: unknown): GovernedVitalSignsTrendEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedVitalSignsTrendEngineLongitudinalEngineEntryView => e !== null);
