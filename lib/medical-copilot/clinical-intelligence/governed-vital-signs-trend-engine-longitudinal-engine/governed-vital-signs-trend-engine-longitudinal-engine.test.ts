...
describe("Vital Signs Trend Engine", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedVitalSignsTrendEngineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Vital Signs Trend Engine", applicableCount: 1,
