...
export type GovernedClinicalRecommendationEngineEntryView = {
...
export type GovernedClinicalRecommendationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalRecommendationEngineEntryView[]; enginesPresent: string[];
