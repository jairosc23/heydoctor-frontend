import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTherapeuticGoalTrackingTherapeuticEngineEntryView, type GovernedTherapeuticGoalTrackingTherapeuticEngineResult } from "./governed-therapeutic-goal-tracking-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTherapeuticGoalTrackingTherapeuticEngineEntryView | null {
...
export function mapGovernedTherapeuticGoalTrackingTherapeuticEngineEnvelope(payload: unknown): GovernedTherapeuticGoalTrackingTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTherapeuticGoalTrackingTherapeuticEngineEntryView => e !== null);
