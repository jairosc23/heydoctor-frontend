...
export type GovernedTherapeuticGoalTrackingTherapeuticEngineEntryView = {
...
export type GovernedTherapeuticGoalTrackingTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTherapeuticGoalTrackingTherapeuticEngineEntryView[];
