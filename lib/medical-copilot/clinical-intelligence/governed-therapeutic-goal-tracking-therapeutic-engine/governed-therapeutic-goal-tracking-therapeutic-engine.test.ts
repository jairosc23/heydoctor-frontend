...
describe("Therapeutic Goal Tracking", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedTherapeuticGoalTrackingTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Therapeutic Goal Tracking", applicableCount: 1,
