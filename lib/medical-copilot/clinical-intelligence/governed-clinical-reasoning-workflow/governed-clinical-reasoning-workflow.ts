...
export type GovernedClinicalReasoningWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalReasoningWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalReasoningWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
