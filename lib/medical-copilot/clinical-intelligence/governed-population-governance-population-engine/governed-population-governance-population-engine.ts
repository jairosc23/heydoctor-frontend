...
export type GovernedPopulationGovernancePopulationEngineEntryView = {
...
export type GovernedPopulationGovernancePopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationGovernancePopulationEngineEntryView[];
