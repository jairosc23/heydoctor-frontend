import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPopulationGovernancePopulationEngineEntryView, type GovernedPopulationGovernancePopulationEngineResult } from "./governed-population-governance-population-engine";
function mapEntry(raw: unknown): GovernedPopulationGovernancePopulationEngineEntryView | null {
...
export function mapGovernedPopulationGovernancePopulationEngineEnvelope(payload: unknown): GovernedPopulationGovernancePopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPopulationGovernancePopulationEngineEntryView => e !== null);
