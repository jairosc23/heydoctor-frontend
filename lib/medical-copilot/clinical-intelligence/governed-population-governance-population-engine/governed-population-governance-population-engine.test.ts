...
describe("Population Governance", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedPopulationGovernancePopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Population Governance", applicableCount: 1,
