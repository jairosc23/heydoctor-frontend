...
export type GovernedClinicalBenchmarkPopulationEngineEntryView = {
...
export type GovernedClinicalBenchmarkPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalBenchmarkPopulationEngineEntryView[];
