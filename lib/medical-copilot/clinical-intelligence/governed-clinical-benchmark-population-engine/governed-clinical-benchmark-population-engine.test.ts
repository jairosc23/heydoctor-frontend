...
describe("Clinical Benchmark", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedClinicalBenchmarkPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Clinical Benchmark", applicableCount: 1,
