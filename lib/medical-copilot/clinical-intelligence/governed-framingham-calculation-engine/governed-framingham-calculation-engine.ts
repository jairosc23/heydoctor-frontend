...
export type GovernedFraminghamCalculationEngineEntryView = {
...
export type GovernedFraminghamCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedFraminghamCalculationEngineEntryView[]; enginesPresent: string[];
