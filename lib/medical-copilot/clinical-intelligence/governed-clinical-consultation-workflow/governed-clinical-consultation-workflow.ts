...
export type GovernedClinicalConsultationWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalConsultationWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalConsultationWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
