...
export type GovernedClinicalMilestoneEngineLongitudinalEngineEntryView = {
...
export type GovernedClinicalMilestoneEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalMilestoneEngineLongitudinalEngineEntryView[];
