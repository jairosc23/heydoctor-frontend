import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedClinicalMilestoneEngineLongitudinalEngineEntryView, type GovernedClinicalMilestoneEngineLongitudinalEngineResult } from "./governed-clinical-milestone-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedClinicalMilestoneEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedClinicalMilestoneEngineLongitudinalEngineEnvelope(payload: unknown): GovernedClinicalMilestoneEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalMilestoneEngineLongitudinalEngineEntryView => e !== null);
