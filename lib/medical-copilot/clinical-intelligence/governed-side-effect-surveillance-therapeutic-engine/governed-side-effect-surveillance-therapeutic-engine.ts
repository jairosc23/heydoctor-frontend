...
export type GovernedSideEffectSurveillanceTherapeuticEngineEntryView = {
...
export type GovernedSideEffectSurveillanceTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedSideEffectSurveillanceTherapeuticEngineEntryView[];
