import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedSideEffectSurveillanceTherapeuticEngineEntryView, type GovernedSideEffectSurveillanceTherapeuticEngineResult } from "./governed-side-effect-surveillance-therapeutic-engine";
function mapEntry(raw: unknown): GovernedSideEffectSurveillanceTherapeuticEngineEntryView | null {
...
export function mapGovernedSideEffectSurveillanceTherapeuticEngineEnvelope(payload: unknown): GovernedSideEffectSurveillanceTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedSideEffectSurveillanceTherapeuticEngineEntryView => e !== null);
