...
export type GovernedWellsPeCalculationEngineEntryView = {
...
export type GovernedWellsPeCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedWellsPeCalculationEngineEntryView[]; enginesPresent: string[];
