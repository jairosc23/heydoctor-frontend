...
export type GovernedDiagnosticLearningDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticLearningDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticLearningDiagnosticIntelEngineEntryView[];
