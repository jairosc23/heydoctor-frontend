...
describe("Quality Dashboard", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedQualityDashboardPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Quality Dashboard", applicableCount: 1,
