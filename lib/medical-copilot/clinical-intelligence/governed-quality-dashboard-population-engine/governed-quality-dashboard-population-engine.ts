...
export type GovernedQualityDashboardPopulationEngineEntryView = {
...
export type GovernedQualityDashboardPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedQualityDashboardPopulationEngineEntryView[];
