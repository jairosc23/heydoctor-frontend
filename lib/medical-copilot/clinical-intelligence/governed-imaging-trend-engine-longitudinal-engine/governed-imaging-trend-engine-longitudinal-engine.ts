...
export type GovernedImagingTrendEngineLongitudinalEngineEntryView = {
...
export type GovernedImagingTrendEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedImagingTrendEngineLongitudinalEngineEntryView[];
