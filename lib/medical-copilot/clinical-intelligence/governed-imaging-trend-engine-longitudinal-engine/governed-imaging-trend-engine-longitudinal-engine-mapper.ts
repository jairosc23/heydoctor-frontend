import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedImagingTrendEngineLongitudinalEngineEntryView, type GovernedImagingTrendEngineLongitudinalEngineResult } from "./governed-imaging-trend-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedImagingTrendEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedImagingTrendEngineLongitudinalEngineEnvelope(payload: unknown): GovernedImagingTrendEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedImagingTrendEngineLongitudinalEngineEntryView => e !== null);
