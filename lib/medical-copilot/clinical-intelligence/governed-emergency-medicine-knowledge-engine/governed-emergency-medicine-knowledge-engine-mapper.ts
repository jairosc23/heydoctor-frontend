import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedEmergencyMedicineKnowledgeEngineEntryView, type GovernedEmergencyMedicineKnowledgeEngineResult } from "./governed-emergency-medicine-knowledge-engine";

function mapEntry(raw: unknown): GovernedEmergencyMedicineKnowledgeEngineEntryView | null {
...
export function mapGovernedEmergencyMedicineKnowledgeEngineEnvelope(payload: unknown): GovernedEmergencyMedicineKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedEmergencyMedicineKnowledgeEngineEntryView => e !== null);
