...
export type GovernedEmergencyMedicineKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEmergencyMedicineKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEmergencyMedicineKnowledgeEngineEntryView[];
