...
export type GovernedQsofaCalculationEngineEntryView = {
...
export type GovernedQsofaCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedQsofaCalculationEngineEntryView[]; enginesPresent: string[];
