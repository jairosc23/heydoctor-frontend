...
describe("Preventive Opportunities", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedPreventiveOpportunitiesPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Preventive Opportunities", applicableCount: 1,
