import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPreventiveOpportunitiesPopulationEngineEntryView, type GovernedPreventiveOpportunitiesPopulationEngineResult } from "./governed-preventive-opportunities-population-engine";
function mapEntry(raw: unknown): GovernedPreventiveOpportunitiesPopulationEngineEntryView | null {
...
export function mapGovernedPreventiveOpportunitiesPopulationEngineEnvelope(payload: unknown): GovernedPreventiveOpportunitiesPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPreventiveOpportunitiesPopulationEngineEntryView => e !== null);
