...
export type GovernedPreventiveOpportunitiesPopulationEngineEntryView = {
...
export type GovernedPreventiveOpportunitiesPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPreventiveOpportunitiesPopulationEngineEntryView[];
