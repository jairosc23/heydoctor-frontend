...
export type GovernedDecisionSafetyEngineEntryView = {
...
export type GovernedDecisionSafetyEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDecisionSafetyEngineEntryView[]; enginesPresent: string[];
