...
export type GovernedClinicalDecisionRuntimeEngineEntryView = {
...
export type GovernedClinicalDecisionRuntimeEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalDecisionRuntimeEngineEntryView[]; enginesPresent: string[];
