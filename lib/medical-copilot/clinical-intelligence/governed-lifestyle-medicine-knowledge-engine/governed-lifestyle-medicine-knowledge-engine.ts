...
export type GovernedLifestyleMedicineKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedLifestyleMedicineKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedLifestyleMedicineKnowledgeEngineEntryView[];
