import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedLifestyleMedicineKnowledgeEngineEntryView, type GovernedLifestyleMedicineKnowledgeEngineResult } from "./governed-lifestyle-medicine-knowledge-engine";

function mapEntry(raw: unknown): GovernedLifestyleMedicineKnowledgeEngineEntryView | null {
...
export function mapGovernedLifestyleMedicineKnowledgeEngineEnvelope(payload: unknown): GovernedLifestyleMedicineKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedLifestyleMedicineKnowledgeEngineEntryView => e !== null);
