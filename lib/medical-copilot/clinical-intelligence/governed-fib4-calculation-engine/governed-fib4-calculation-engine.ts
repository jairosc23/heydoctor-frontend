...
export type GovernedFib4CalculationEngineEntryView = {
...
export type GovernedFib4CalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedFib4CalculationEngineEntryView[]; enginesPresent: string[];
