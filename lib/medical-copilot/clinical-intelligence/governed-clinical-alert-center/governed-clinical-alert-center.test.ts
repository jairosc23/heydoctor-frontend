...
import { GOVERNED_CLINICAL_INTELLIGENCE_UI_GOVERNANCE } from "./governed-clinical-alert-center";
import { mapGovernedClinicalAlertCenterEnvelope } from "./governed-clinical-alert-center-mapper";

describe("GovernedClinicalAlertCenter mapper", () => {
  it("maps HITL intelligence surface without write flags", () => {
    const mapped = mapGovernedClinicalAlertCenterEnvelope({
    ...
    assert.equal(mapGovernedClinicalAlertCenterEnvelope(null), null);
  });
});
