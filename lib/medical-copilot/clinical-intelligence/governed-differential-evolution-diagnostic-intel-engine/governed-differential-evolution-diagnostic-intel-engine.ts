...
export type GovernedDifferentialEvolutionDiagnosticIntelEngineEntryView = {
...
export type GovernedDifferentialEvolutionDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDifferentialEvolutionDiagnosticIntelEngineEntryView[];
