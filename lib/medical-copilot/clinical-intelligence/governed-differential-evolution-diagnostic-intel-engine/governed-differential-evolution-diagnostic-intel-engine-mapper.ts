import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDifferentialEvolutionDiagnosticIntelEngineEntryView, type GovernedDifferentialEvolutionDiagnosticIntelEngineResult } from "./governed-differential-evolution-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDifferentialEvolutionDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDifferentialEvolutionDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDifferentialEvolutionDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDifferentialEvolutionDiagnosticIntelEngineEntryView => e !== null);
