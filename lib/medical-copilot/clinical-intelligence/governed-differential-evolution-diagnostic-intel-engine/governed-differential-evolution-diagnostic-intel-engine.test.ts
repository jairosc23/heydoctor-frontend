...
describe("Differential Evolution", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDifferentialEvolutionDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Differential Evolution", applicableCount: 1,
