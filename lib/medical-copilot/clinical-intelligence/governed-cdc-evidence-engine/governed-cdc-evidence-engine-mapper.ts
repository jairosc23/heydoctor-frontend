import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedCdcEvidenceEngineEntryView, type GovernedCdcEvidenceEngineResult } from "./governed-cdc-evidence-engine";

function mapEntry(raw: unknown): GovernedCdcEvidenceEngineEntryView | null {
...
export function mapGovernedCdcEvidenceEngineEnvelope(payload: unknown): GovernedCdcEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedCdcEvidenceEngineEntryView => e !== null);
