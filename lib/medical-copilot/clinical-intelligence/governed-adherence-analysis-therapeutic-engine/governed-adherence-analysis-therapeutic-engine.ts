...
export type GovernedAdherenceAnalysisTherapeuticEngineEntryView = {
...
export type GovernedAdherenceAnalysisTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedAdherenceAnalysisTherapeuticEngineEntryView[];
