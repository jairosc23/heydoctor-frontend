import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedAdherenceAnalysisTherapeuticEngineEntryView, type GovernedAdherenceAnalysisTherapeuticEngineResult } from "./governed-adherence-analysis-therapeutic-engine";
function mapEntry(raw: unknown): GovernedAdherenceAnalysisTherapeuticEngineEntryView | null {
...
export function mapGovernedAdherenceAnalysisTherapeuticEngineEnvelope(payload: unknown): GovernedAdherenceAnalysisTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAdherenceAnalysisTherapeuticEngineEntryView => e !== null);
