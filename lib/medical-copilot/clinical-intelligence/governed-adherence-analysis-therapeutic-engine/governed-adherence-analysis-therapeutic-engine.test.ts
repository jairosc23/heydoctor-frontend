...
describe("Adherence Analysis", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedAdherenceAnalysisTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Adherence Analysis", applicableCount: 1,
