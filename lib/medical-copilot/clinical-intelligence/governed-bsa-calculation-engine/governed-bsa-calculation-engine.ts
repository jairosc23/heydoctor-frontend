...
export type GovernedBsaCalculationEngineEntryView = {
...
export type GovernedBsaCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedBsaCalculationEngineEntryView[]; enginesPresent: string[];
