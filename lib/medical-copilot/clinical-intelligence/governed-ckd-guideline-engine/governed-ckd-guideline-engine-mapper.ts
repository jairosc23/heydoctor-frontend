import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedCkdGuidelineEngineEntryView, type GovernedCkdGuidelineEngineResult } from "./governed-ckd-guideline-engine";

function mapEntry(raw: unknown): GovernedCkdGuidelineEngineEntryView | null {
...
export function mapGovernedCkdGuidelineEngineEnvelope(payload: unknown): GovernedCkdGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedCkdGuidelineEngineEntryView => e !== null);
