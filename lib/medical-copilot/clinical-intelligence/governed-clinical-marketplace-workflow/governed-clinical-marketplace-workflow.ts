...
export type GovernedClinicalMarketplaceWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalMarketplaceWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalMarketplaceWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
