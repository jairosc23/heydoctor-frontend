...
export type GovernedPediatricsKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedPediatricsKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedPediatricsKnowledgeEngineEntryView[];
