...
export type GovernedWellsDvtCalculationEngineEntryView = {
...
export type GovernedWellsDvtCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedWellsDvtCalculationEngineEntryView[]; enginesPresent: string[];
