...
export type GovernedPopulationScreeningPopulationEngineEntryView = {
...
export type GovernedPopulationScreeningPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationScreeningPopulationEngineEntryView[];
