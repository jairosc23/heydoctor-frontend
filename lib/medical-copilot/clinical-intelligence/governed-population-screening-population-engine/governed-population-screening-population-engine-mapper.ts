import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPopulationScreeningPopulationEngineEntryView, type GovernedPopulationScreeningPopulationEngineResult } from "./governed-population-screening-population-engine";
function mapEntry(raw: unknown): GovernedPopulationScreeningPopulationEngineEntryView | null {
...
export function mapGovernedPopulationScreeningPopulationEngineEnvelope(payload: unknown): GovernedPopulationScreeningPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPopulationScreeningPopulationEngineEntryView => e !== null);
