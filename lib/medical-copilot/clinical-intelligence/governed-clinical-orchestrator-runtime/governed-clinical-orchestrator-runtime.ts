...
export type GovernedClinicalOrchestratorRuntimeRefView = {
...
export type GovernedOrchestratorAggregatorView = {
  ...
  surfaceRefs: GovernedClinicalOrchestratorRuntimeRefView[];
};
export type GovernedClinicalOrchestratorRuntimeResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
