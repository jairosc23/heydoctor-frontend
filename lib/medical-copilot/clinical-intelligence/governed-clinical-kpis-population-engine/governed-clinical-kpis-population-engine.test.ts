...
describe("Clinical KPIs", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedClinicalKpisPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Clinical KPIs", applicableCount: 1,
