...
export type GovernedClinicalKpisPopulationEngineEntryView = {
...
export type GovernedClinicalKpisPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalKpisPopulationEngineEntryView[];
