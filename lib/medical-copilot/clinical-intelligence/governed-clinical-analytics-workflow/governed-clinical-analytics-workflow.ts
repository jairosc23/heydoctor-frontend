...
export type GovernedClinicalAnalyticsWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalAnalyticsWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalAnalyticsWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
