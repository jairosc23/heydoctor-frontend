...
export type GovernedPreventiveCoveragePopulationEngineEntryView = {
...
export type GovernedPreventiveCoveragePopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPreventiveCoveragePopulationEngineEntryView[];
