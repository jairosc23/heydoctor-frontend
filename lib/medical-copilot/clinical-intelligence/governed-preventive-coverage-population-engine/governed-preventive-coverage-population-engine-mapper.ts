import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPreventiveCoveragePopulationEngineEntryView, type GovernedPreventiveCoveragePopulationEngineResult } from "./governed-preventive-coverage-population-engine";
function mapEntry(raw: unknown): GovernedPreventiveCoveragePopulationEngineEntryView | null {
...
export function mapGovernedPreventiveCoveragePopulationEngineEnvelope(payload: unknown): GovernedPreventiveCoveragePopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPreventiveCoveragePopulationEngineEntryView => e !== null);
