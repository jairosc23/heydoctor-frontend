...
describe("Preventive Coverage", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedPreventiveCoveragePopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Preventive Coverage", applicableCount: 1,
