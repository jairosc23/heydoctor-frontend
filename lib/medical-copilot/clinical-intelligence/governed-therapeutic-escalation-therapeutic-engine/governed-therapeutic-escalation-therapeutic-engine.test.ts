...
describe("Therapeutic Escalation", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedTherapeuticEscalationTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Therapeutic Escalation", applicableCount: 1,
