import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTherapeuticEscalationTherapeuticEngineEntryView, type GovernedTherapeuticEscalationTherapeuticEngineResult } from "./governed-therapeutic-escalation-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTherapeuticEscalationTherapeuticEngineEntryView | null {
...
export function mapGovernedTherapeuticEscalationTherapeuticEngineEnvelope(payload: unknown): GovernedTherapeuticEscalationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTherapeuticEscalationTherapeuticEngineEntryView => e !== null);
