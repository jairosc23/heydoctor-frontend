...
export type GovernedTherapeuticEscalationTherapeuticEngineEntryView = {
...
export type GovernedTherapeuticEscalationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTherapeuticEscalationTherapeuticEngineEntryView[];
