...
export type GovernedClinicalIntelligenceAggregatorRefView = {
...
export type GovernedOrchestratorAggregatorView = {
  ...
  surfaceRefs: GovernedClinicalIntelligenceAggregatorRefView[];
};
export type GovernedClinicalIntelligenceAggregatorResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
