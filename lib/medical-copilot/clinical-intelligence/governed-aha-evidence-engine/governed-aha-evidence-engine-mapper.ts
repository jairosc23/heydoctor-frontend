import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAhaEvidenceEngineEntryView, type GovernedAhaEvidenceEngineResult } from "./governed-aha-evidence-engine";

function mapEntry(raw: unknown): GovernedAhaEvidenceEngineEntryView | null {
...
export function mapGovernedAhaEvidenceEngineEnvelope(payload: unknown): GovernedAhaEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAhaEvidenceEngineEntryView => e !== null);
