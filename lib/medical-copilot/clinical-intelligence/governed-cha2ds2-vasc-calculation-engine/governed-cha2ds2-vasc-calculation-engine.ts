...
export type GovernedCha2ds2VascCalculationEngineEntryView = {
...
export type GovernedCha2ds2VascCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCha2ds2VascCalculationEngineEntryView[]; enginesPresent: string[];
