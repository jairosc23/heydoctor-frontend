import { GOVERNED_CLINICAL_CALCULATION_SYSTEM_ENTERPRISE_UI_GOVERNANCE, type GovernedCha2ds2VascCalculationEngineEntryView, type GovernedCha2ds2VascCalculationEngineResult } from "./governed-cha2ds2-vasc-calculation-engine";
function mapEntry(raw: unknown): GovernedCha2ds2VascCalculationEngineEntryView | null {
...
export function mapGovernedCha2ds2VascCalculationEngineEnvelope(payload: unknown): GovernedCha2ds2VascCalculationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedCha2ds2VascCalculationEngineEntryView => e !== null);
