import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedMissingDiagnosisDetectionDiagnosticIntelEngineEntryView, type GovernedMissingDiagnosisDetectionDiagnosticIntelEngineResult } from "./governed-missing-diagnosis-detection-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedMissingDiagnosisDetectionDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedMissingDiagnosisDetectionDiagnosticIntelEngineEnvelope(payload: unknown): GovernedMissingDiagnosisDetectionDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedMissingDiagnosisDetectionDiagnosticIntelEngineEntryView => e !== null);
