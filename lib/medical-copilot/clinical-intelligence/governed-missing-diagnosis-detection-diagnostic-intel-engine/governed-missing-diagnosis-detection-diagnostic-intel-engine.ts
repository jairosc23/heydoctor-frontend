...
export type GovernedMissingDiagnosisDetectionDiagnosticIntelEngineEntryView = {
...
export type GovernedMissingDiagnosisDetectionDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMissingDiagnosisDetectionDiagnosticIntelEngineEntryView[];
