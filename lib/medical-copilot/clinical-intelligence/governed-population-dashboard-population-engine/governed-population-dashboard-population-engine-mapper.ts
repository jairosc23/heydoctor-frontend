import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPopulationDashboardPopulationEngineEntryView, type GovernedPopulationDashboardPopulationEngineResult } from "./governed-population-dashboard-population-engine";
function mapEntry(raw: unknown): GovernedPopulationDashboardPopulationEngineEntryView | null {
...
export function mapGovernedPopulationDashboardPopulationEngineEnvelope(payload: unknown): GovernedPopulationDashboardPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPopulationDashboardPopulationEngineEntryView => e !== null);
