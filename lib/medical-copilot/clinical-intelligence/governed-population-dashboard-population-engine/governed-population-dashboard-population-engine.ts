...
export type GovernedPopulationDashboardPopulationEngineEntryView = {
...
export type GovernedPopulationDashboardPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationDashboardPopulationEngineEntryView[];
