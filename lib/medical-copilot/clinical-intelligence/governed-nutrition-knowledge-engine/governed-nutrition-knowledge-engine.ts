...
export type GovernedNutritionKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedNutritionKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedNutritionKnowledgeEngineEntryView[];
