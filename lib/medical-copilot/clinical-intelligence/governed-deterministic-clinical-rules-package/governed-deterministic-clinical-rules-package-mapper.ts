import { GOVERNED_DETERMINISTIC_CLINICAL_RULES_UI_GOVERNANCE, type GovernedDeterministicClinicalRulesPackageEvaluationView, type GovernedDeterministicClinicalRulesPackageResult } from "./governed-deterministic-clinical-rules-package";

function mapEvaluation(raw: unknown): GovernedDeterministicClinicalRulesPackageEvaluationView | null {
...
export function mapGovernedDeterministicClinicalRulesPackageEnvelope(payload: unknown): GovernedDeterministicClinicalRulesPackageResult | null {
  ...
  const evaluations = evaluationsRaw.map(mapEvaluation).filter((e): e is GovernedDeterministicClinicalRulesPackageEvaluationView => e !== null);
