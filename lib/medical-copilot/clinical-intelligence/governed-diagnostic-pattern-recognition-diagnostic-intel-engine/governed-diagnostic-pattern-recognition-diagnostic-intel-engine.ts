export const GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE = {
...
export type EnterpriseUiGovernance = typeof GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE;
export type GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEntryView = {
  entryId: string; entryTitle: string; domain: string; topic: string; summary: string; explanation: string;
  evidenceRefs: string[]; diagnosticRole: string; applicability: string; confidence: string;
};
export type GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEntryView[];
