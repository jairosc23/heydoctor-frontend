import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEntryView, type GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineResult } from "./governed-diagnostic-pattern-recognition-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticPatternRecognitionDiagnosticIntelEngineEntryView => e !== null);
