...
export type GovernedTherapeuticDeEscalationTherapeuticEngineEntryView = {
...
export type GovernedTherapeuticDeEscalationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTherapeuticDeEscalationTherapeuticEngineEntryView[];
