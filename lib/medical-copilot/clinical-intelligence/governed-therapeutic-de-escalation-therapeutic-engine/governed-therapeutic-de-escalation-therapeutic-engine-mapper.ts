import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTherapeuticDeEscalationTherapeuticEngineEntryView, type GovernedTherapeuticDeEscalationTherapeuticEngineResult } from "./governed-therapeutic-de-escalation-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTherapeuticDeEscalationTherapeuticEngineEntryView | null {
...
export function mapGovernedTherapeuticDeEscalationTherapeuticEngineEnvelope(payload: unknown): GovernedTherapeuticDeEscalationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTherapeuticDeEscalationTherapeuticEngineEntryView => e !== null);
