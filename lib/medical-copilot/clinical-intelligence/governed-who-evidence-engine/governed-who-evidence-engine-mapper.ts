import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedWhoEvidenceEngineEntryView, type GovernedWhoEvidenceEngineResult } from "./governed-who-evidence-engine";

function mapEntry(raw: unknown): GovernedWhoEvidenceEngineEntryView | null {
...
export function mapGovernedWhoEvidenceEngineEnvelope(payload: unknown): GovernedWhoEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedWhoEvidenceEngineEntryView => e !== null);
