...
export type GovernedOttawaKneeRulesCalculationEngineEntryView = {
...
export type GovernedOttawaKneeRulesCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedOttawaKneeRulesCalculationEngineEntryView[]; enginesPresent: string[];
