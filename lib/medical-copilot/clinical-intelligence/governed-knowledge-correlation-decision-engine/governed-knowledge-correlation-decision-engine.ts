...
export type GovernedKnowledgeCorrelationEngineEntryView = {
...
export type GovernedKnowledgeCorrelationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedKnowledgeCorrelationEngineEntryView[]; enginesPresent: string[];
