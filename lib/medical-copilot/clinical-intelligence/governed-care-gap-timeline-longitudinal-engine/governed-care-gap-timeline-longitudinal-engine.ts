...
export type GovernedCareGapTimelineLongitudinalEngineEntryView = {
...
export type GovernedCareGapTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCareGapTimelineLongitudinalEngineEntryView[];
