import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedTherapeuticRecommendationsTherapeuticEngineEntryView, type GovernedTherapeuticRecommendationsTherapeuticEngineResult } from "./governed-therapeutic-recommendations-therapeutic-engine";
function mapEntry(raw: unknown): GovernedTherapeuticRecommendationsTherapeuticEngineEntryView | null {
...
export function mapGovernedTherapeuticRecommendationsTherapeuticEngineEnvelope(payload: unknown): GovernedTherapeuticRecommendationsTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedTherapeuticRecommendationsTherapeuticEngineEntryView => e !== null);
