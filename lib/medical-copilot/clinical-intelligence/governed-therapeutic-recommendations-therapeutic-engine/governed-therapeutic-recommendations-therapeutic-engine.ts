...
export type GovernedTherapeuticRecommendationsTherapeuticEngineEntryView = {
...
export type GovernedTherapeuticRecommendationsTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedTherapeuticRecommendationsTherapeuticEngineEntryView[];
