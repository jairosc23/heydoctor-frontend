...
export type GovernedHasBledCalculationEngineEntryView = {
...
export type GovernedHasBledCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedHasBledCalculationEngineEntryView[]; enginesPresent: string[];
