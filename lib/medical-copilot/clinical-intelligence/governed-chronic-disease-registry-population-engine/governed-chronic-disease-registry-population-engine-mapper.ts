import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedChronicDiseaseRegistryPopulationEngineEntryView, type GovernedChronicDiseaseRegistryPopulationEngineResult } from "./governed-chronic-disease-registry-population-engine";
function mapEntry(raw: unknown): GovernedChronicDiseaseRegistryPopulationEngineEntryView | null {
...
export function mapGovernedChronicDiseaseRegistryPopulationEngineEnvelope(payload: unknown): GovernedChronicDiseaseRegistryPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedChronicDiseaseRegistryPopulationEngineEntryView => e !== null);
