...
export type GovernedChronicDiseaseRegistryPopulationEngineEntryView = {
...
export type GovernedChronicDiseaseRegistryPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedChronicDiseaseRegistryPopulationEngineEntryView[];
