...
export type GovernedDiagnosticEvidenceDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticEvidenceDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticEvidenceDiagnosticIntelEngineEntryView[];
