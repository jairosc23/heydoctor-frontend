...
export type GovernedClinicalTransparencyEngineEntryView = {
...
export type GovernedClinicalTransparencyEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalTransparencyEngineEntryView[]; enginesPresent: string[];
