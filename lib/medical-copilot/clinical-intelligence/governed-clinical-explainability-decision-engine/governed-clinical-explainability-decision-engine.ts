...
export type GovernedClinicalExplainabilityEngineEntryView = {
...
export type GovernedClinicalExplainabilityEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalExplainabilityEngineEntryView[]; enginesPresent: string[];
