...
export type GovernedEvidenceCorrelationEngineEntryView = {
...
export type GovernedEvidenceCorrelationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedEvidenceCorrelationEngineEntryView[]; enginesPresent: string[];
