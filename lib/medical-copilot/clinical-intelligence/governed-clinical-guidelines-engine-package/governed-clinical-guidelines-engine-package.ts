...
export type GovernedClinicalGuidelinesEnginePackageEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedClinicalGuidelinesEnginePackageResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedClinicalGuidelinesEnginePackageEntryView[];
