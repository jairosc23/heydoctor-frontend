...
export type GovernedVaccinationCoveragePopulationEngineEntryView = {
...
export type GovernedVaccinationCoveragePopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedVaccinationCoveragePopulationEngineEntryView[];
