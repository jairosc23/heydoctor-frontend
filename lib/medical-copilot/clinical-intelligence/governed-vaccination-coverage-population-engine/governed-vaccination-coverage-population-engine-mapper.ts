import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedVaccinationCoveragePopulationEngineEntryView, type GovernedVaccinationCoveragePopulationEngineResult } from "./governed-vaccination-coverage-population-engine";
function mapEntry(raw: unknown): GovernedVaccinationCoveragePopulationEngineEntryView | null {
...
export function mapGovernedVaccinationCoveragePopulationEngineEnvelope(payload: unknown): GovernedVaccinationCoveragePopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedVaccinationCoveragePopulationEngineEntryView => e !== null);
