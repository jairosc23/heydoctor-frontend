...
export type GovernedPercCalculationEngineEntryView = {
...
export type GovernedPercCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPercCalculationEngineEntryView[]; enginesPresent: string[];
