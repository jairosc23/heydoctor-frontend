import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedLaboratoryTrendEngineLongitudinalEngineEntryView, type GovernedLaboratoryTrendEngineLongitudinalEngineResult } from "./governed-laboratory-trend-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedLaboratoryTrendEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedLaboratoryTrendEngineLongitudinalEngineEnvelope(payload: unknown): GovernedLaboratoryTrendEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedLaboratoryTrendEngineLongitudinalEngineEntryView => e !== null);
