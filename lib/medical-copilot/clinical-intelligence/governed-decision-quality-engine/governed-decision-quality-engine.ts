...
export type GovernedDecisionQualityEngineEntryView = {
...
export type GovernedDecisionQualityEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDecisionQualityEngineEntryView[]; enginesPresent: string[];
