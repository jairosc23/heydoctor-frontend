...
export type GovernedClinicalPersistenceWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalPersistenceWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalPersistenceWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
