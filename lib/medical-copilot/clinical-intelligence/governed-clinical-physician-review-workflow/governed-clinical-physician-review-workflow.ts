...
export type GovernedClinicalPhysicianReviewWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalPhysicianReviewWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalPhysicianReviewWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
