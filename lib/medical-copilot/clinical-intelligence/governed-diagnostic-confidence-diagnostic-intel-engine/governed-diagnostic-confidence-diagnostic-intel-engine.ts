...
export type GovernedDiagnosticConfidenceDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticConfidenceDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticConfidenceDiagnosticIntelEngineEntryView[];
