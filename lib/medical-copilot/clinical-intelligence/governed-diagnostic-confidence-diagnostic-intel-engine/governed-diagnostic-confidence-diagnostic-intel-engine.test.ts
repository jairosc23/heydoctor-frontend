...
describe("Diagnostic Confidence", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticConfidenceDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Confidence", applicableCount: 1,
