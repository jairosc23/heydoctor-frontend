...
export type GovernedClinicalGuidelineEvidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedClinicalGuidelineEvidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedClinicalGuidelineEvidenceEngineEntryView[];
