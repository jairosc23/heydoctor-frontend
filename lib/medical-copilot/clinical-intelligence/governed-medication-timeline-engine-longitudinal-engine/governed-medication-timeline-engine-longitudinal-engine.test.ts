...
describe("Medication Timeline Engine", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedMedicationTimelineEngineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Medication Timeline Engine", applicableCount: 1,
