...
export type GovernedMedicationTimelineEngineLongitudinalEngineEntryView = {
...
export type GovernedMedicationTimelineEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMedicationTimelineEngineLongitudinalEngineEntryView[];
