import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedMedicationTimelineEngineLongitudinalEngineEntryView, type GovernedMedicationTimelineEngineLongitudinalEngineResult } from "./governed-medication-timeline-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedMedicationTimelineEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedMedicationTimelineEngineLongitudinalEngineEnvelope(payload: unknown): GovernedMedicationTimelineEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedMedicationTimelineEngineLongitudinalEngineEntryView => e !== null);
