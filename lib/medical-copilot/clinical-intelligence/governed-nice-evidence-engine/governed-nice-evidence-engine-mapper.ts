import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedNiceEvidenceEngineEntryView, type GovernedNiceEvidenceEngineResult } from "./governed-nice-evidence-engine";

function mapEntry(raw: unknown): GovernedNiceEvidenceEngineEntryView | null {
...
export function mapGovernedNiceEvidenceEngineEnvelope(payload: unknown): GovernedNiceEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedNiceEvidenceEngineEntryView => e !== null);
