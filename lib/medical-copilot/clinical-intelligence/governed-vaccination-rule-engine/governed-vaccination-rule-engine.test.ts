...
describe("GovernedVaccinationRuleEngine mapper", () => {
  it("maps deterministic rule evaluations with explainability fields", () => {
    const mapped = mapGovernedVaccinationRuleEngineEnvelope({
    ...
    assert.equal(mapGovernedVaccinationRuleEngineEnvelope(null), null);
  });
});
