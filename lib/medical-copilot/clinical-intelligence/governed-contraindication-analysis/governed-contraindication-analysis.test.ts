...
import { GOVERNED_CLINICAL_INTELLIGENCE_UI_GOVERNANCE } from "./governed-contraindication-analysis";
import { mapGovernedContraindicationAnalysisEnvelope } from "./governed-contraindication-analysis-mapper";

describe("GovernedContraindicationAnalysis mapper", () => {
  it("maps HITL intelligence surface without write flags", () => {
    const mapped = mapGovernedContraindicationAnalysisEnvelope({
    ...
    assert.equal(mapGovernedContraindicationAnalysisEnvelope(null), null);
  });
});
