...
export type GovernedHypothesisValidationEngineEntryView = {
...
export type GovernedHypothesisValidationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedHypothesisValidationEngineEntryView[]; enginesPresent: string[];
