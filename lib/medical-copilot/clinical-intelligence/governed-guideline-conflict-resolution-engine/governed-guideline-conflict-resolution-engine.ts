...
export type GovernedGuidelineConflictResolutionEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedGuidelineConflictResolutionEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedGuidelineConflictResolutionEngineEntryView[];
