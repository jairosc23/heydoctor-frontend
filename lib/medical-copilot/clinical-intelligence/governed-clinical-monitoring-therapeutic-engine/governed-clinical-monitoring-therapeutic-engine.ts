...
export type GovernedClinicalMonitoringTherapeuticEngineEntryView = {
...
export type GovernedClinicalMonitoringTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalMonitoringTherapeuticEngineEntryView[];
