import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedClinicalMonitoringTherapeuticEngineEntryView, type GovernedClinicalMonitoringTherapeuticEngineResult } from "./governed-clinical-monitoring-therapeutic-engine";
function mapEntry(raw: unknown): GovernedClinicalMonitoringTherapeuticEngineEntryView | null {
...
export function mapGovernedClinicalMonitoringTherapeuticEngineEnvelope(payload: unknown): GovernedClinicalMonitoringTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalMonitoringTherapeuticEngineEntryView => e !== null);
