...
export type GovernedPopulationExplainabilityPopulationEngineEntryView = {
...
export type GovernedPopulationExplainabilityPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationExplainabilityPopulationEngineEntryView[];
