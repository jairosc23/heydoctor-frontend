...
describe("Clinical Outcomes", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedClinicalOutcomesPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Clinical Outcomes", applicableCount: 1,
