import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedClinicalOutcomesPopulationEngineEntryView, type GovernedClinicalOutcomesPopulationEngineResult } from "./governed-clinical-outcomes-population-engine";
function mapEntry(raw: unknown): GovernedClinicalOutcomesPopulationEngineEntryView | null {
...
export function mapGovernedClinicalOutcomesPopulationEngineEnvelope(payload: unknown): GovernedClinicalOutcomesPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalOutcomesPopulationEngineEntryView => e !== null);
