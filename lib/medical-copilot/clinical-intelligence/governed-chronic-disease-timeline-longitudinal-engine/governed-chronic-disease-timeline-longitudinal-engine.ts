...
export type GovernedChronicDiseaseTimelineLongitudinalEngineEntryView = {
...
export type GovernedChronicDiseaseTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedChronicDiseaseTimelineLongitudinalEngineEntryView[];
