...
export type GovernedClinicalEvidenceEnginePackageEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedClinicalEvidenceEnginePackageResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedClinicalEvidenceEnginePackageEntryView[];
