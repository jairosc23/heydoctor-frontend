...
export type GovernedClinicalDocumentationWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalDocumentationWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalDocumentationWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
