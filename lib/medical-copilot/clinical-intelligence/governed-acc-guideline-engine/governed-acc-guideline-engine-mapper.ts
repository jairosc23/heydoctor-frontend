import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAccGuidelineEngineEntryView, type GovernedAccGuidelineEngineResult } from "./governed-acc-guideline-engine";

function mapEntry(raw: unknown): GovernedAccGuidelineEngineEntryView | null {
...
export function mapGovernedAccGuidelineEngineEnvelope(payload: unknown): GovernedAccGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAccGuidelineEngineEntryView => e !== null);
