...
export type GovernedEvidenceConsistencyEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEvidenceConsistencyEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEvidenceConsistencyEngineEntryView[];
