...
export type GovernedClinicalEvidenceWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalEvidenceWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalEvidenceWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
