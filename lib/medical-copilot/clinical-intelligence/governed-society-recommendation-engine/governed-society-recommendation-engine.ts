...
export type GovernedSocietyRecommendationEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedSocietyRecommendationEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedSocietyRecommendationEngineEntryView[];
