...
export type GovernedClinicalKnowledgeWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalKnowledgeWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalKnowledgeWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
