...
describe("Readmission Risk", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedReadmissionRiskPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Readmission Risk", applicableCount: 1,
