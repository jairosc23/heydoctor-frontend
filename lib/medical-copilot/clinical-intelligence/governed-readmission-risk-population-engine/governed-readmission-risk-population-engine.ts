...
export type GovernedReadmissionRiskPopulationEngineEntryView = {
...
export type GovernedReadmissionRiskPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedReadmissionRiskPopulationEngineEntryView[];
