...
export type GovernedEvidenceTraceabilityEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEvidenceTraceabilityEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEvidenceTraceabilityEngineEntryView[];
