import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedContraindicationKnowledgeEngineEntryView, type GovernedContraindicationKnowledgeEngineResult } from "./governed-contraindication-knowledge-engine";

function mapEntry(raw: unknown): GovernedContraindicationKnowledgeEngineEntryView | null {
...
export function mapGovernedContraindicationKnowledgeEngineEnvelope(payload: unknown): GovernedContraindicationKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedContraindicationKnowledgeEngineEntryView => e !== null);
