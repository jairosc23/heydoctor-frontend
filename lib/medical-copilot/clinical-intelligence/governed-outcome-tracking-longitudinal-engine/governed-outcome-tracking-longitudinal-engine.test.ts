...
describe("Outcome Tracking", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedOutcomeTrackingLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Outcome Tracking", applicableCount: 1,
