...
export type GovernedOutcomeTrackingLongitudinalEngineEntryView = {
...
export type GovernedOutcomeTrackingLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedOutcomeTrackingLongitudinalEngineEntryView[];
