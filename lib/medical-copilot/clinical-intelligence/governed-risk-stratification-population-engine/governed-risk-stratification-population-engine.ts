...
export type GovernedRiskStratificationPopulationEngineEntryView = {
...
export type GovernedRiskStratificationPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedRiskStratificationPopulationEngineEntryView[];
