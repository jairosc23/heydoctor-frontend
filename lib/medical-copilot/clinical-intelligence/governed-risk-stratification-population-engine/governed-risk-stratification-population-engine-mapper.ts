import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedRiskStratificationPopulationEngineEntryView, type GovernedRiskStratificationPopulationEngineResult } from "./governed-risk-stratification-population-engine";
function mapEntry(raw: unknown): GovernedRiskStratificationPopulationEngineEntryView | null {
...
export function mapGovernedRiskStratificationPopulationEngineEnvelope(payload: unknown): GovernedRiskStratificationPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedRiskStratificationPopulationEngineEntryView => e !== null);
