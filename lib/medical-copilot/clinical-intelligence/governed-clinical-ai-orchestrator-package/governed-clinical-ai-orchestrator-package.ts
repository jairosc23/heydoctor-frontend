...
export type GovernedClinicalAiOrchestratorPackageRefView = {
...
export type GovernedOrchestratorAggregatorView = {
  ...
  surfaceRefs: GovernedClinicalAiOrchestratorPackageRefView[];
};
export type GovernedClinicalAiOrchestratorPackageResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
