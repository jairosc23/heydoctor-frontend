...
export type GovernedClinicalInterventionPlanningTherapeuticEngineEntryView = {
...
export type GovernedClinicalInterventionPlanningTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalInterventionPlanningTherapeuticEngineEntryView[];
