...
export type GovernedDiagnosticIntelligencePackageEntryView = {
...
export type GovernedDiagnosticIntelligencePackageResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticIntelligencePackageEntryView[];
