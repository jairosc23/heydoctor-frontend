...
export type GovernedChildPughCalculationEngineEntryView = {
...
export type GovernedChildPughCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedChildPughCalculationEngineEntryView[]; enginesPresent: string[];
