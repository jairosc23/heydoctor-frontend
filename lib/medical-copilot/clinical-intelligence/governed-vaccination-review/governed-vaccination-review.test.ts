...
import { GOVERNED_CLINICAL_INTELLIGENCE_UI_GOVERNANCE } from "./governed-vaccination-review";
import { mapGovernedVaccinationReviewEnvelope } from "./governed-vaccination-review-mapper";

describe("GovernedVaccinationReview mapper", () => {
  it("maps HITL intelligence surface without write flags", () => {
    const mapped = mapGovernedVaccinationReviewEnvelope({
    ...
    assert.equal(mapGovernedVaccinationReviewEnvelope(null), null);
  });
});
