...
export type GovernedClinicalProtocolEvidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedClinicalProtocolEvidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedClinicalProtocolEvidenceEngineEntryView[];
