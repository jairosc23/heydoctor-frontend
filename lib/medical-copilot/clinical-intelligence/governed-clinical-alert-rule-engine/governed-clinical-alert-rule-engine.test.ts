...
describe("GovernedClinicalAlertRuleEngine mapper", () => {
  it("maps deterministic rule evaluations with explainability fields", () => {
    const mapped = mapGovernedClinicalAlertRuleEngineEnvelope({
    ...
    assert.equal(mapGovernedClinicalAlertRuleEngineEnvelope(null), null);
  });
});
