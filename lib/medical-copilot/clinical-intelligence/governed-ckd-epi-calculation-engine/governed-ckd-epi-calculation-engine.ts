...
export type GovernedCkdEpiCalculationEngineEntryView = {
...
export type GovernedCkdEpiCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCkdEpiCalculationEngineEntryView[]; enginesPresent: string[];
