...
export type GovernedDecisionGovernanceEngineEntryView = {
...
export type GovernedDecisionGovernanceEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDecisionGovernanceEngineEntryView[]; enginesPresent: string[];
