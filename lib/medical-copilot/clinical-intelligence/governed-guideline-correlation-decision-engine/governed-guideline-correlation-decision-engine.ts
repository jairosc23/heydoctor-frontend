...
export type GovernedGuidelineCorrelationEngineEntryView = {
...
export type GovernedGuidelineCorrelationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedGuidelineCorrelationEngineEntryView[]; enginesPresent: string[];
