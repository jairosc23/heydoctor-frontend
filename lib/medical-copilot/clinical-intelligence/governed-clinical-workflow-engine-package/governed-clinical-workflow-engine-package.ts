...
export type GovernedClinicalWorkflowEnginePackageRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalWorkflowEnginePackageRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalWorkflowEnginePackageResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
