...
export type GovernedDrugMonitoringTherapeuticEngineEntryView = {
...
export type GovernedDrugMonitoringTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDrugMonitoringTherapeuticEngineEntryView[];
