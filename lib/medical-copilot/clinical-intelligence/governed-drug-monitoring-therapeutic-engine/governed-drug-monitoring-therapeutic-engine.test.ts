...
describe("Drug Monitoring", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDrugMonitoringTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Drug Monitoring", applicableCount: 1,
