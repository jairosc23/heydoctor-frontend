...
export type GovernedGlasgowCalculationEngineEntryView = {
...
export type GovernedGlasgowCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedGlasgowCalculationEngineEntryView[]; enginesPresent: string[];
