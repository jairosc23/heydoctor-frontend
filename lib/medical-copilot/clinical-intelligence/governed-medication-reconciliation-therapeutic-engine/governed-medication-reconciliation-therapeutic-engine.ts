...
export type GovernedMedicationReconciliationTherapeuticEngineEntryView = {
...
export type GovernedMedicationReconciliationTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMedicationReconciliationTherapeuticEngineEntryView[];
