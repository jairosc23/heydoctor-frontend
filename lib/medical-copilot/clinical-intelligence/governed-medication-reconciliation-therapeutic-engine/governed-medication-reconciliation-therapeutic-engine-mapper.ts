import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedMedicationReconciliationTherapeuticEngineEntryView, type GovernedMedicationReconciliationTherapeuticEngineResult } from "./governed-medication-reconciliation-therapeutic-engine";
function mapEntry(raw: unknown): GovernedMedicationReconciliationTherapeuticEngineEntryView | null {
...
export function mapGovernedMedicationReconciliationTherapeuticEngineEnvelope(payload: unknown): GovernedMedicationReconciliationTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedMedicationReconciliationTherapeuticEngineEntryView => e !== null);
