...
export type GovernedChronicDiseaseKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedChronicDiseaseKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedChronicDiseaseKnowledgeEngineEntryView[];
