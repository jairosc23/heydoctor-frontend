...
export type GovernedHospitalizationTimelineLongitudinalEngineEntryView = {
...
export type GovernedHospitalizationTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedHospitalizationTimelineLongitudinalEngineEntryView[];
