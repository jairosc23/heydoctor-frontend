import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedHospitalizationTimelineLongitudinalEngineEntryView, type GovernedHospitalizationTimelineLongitudinalEngineResult } from "./governed-hospitalization-timeline-longitudinal-engine";
function mapEntry(raw: unknown): GovernedHospitalizationTimelineLongitudinalEngineEntryView | null {
...
export function mapGovernedHospitalizationTimelineLongitudinalEngineEnvelope(payload: unknown): GovernedHospitalizationTimelineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedHospitalizationTimelineLongitudinalEngineEntryView => e !== null);
