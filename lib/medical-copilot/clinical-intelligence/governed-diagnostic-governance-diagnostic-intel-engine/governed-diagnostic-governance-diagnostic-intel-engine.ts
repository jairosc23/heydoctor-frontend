...
export type GovernedDiagnosticGovernanceDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticGovernanceDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticGovernanceDiagnosticIntelEngineEntryView[];
