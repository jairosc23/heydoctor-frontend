...
describe("Diagnostic Governance", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticGovernanceDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Governance", applicableCount: 1,
