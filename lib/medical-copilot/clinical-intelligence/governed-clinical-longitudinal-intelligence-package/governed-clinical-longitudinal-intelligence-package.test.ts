...
describe("Longitudinal Intelligence Package", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedClinicalLongitudinalIntelligencePackageEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Longitudinal Intelligence Package", applicableCount: 1,
