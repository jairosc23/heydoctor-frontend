import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedClinicalLongitudinalIntelligencePackageEntryView, type GovernedClinicalLongitudinalIntelligencePackageResult } from "./governed-clinical-longitudinal-intelligence-package";
function mapEntry(raw: unknown): GovernedClinicalLongitudinalIntelligencePackageEntryView | null {
...
export function mapGovernedClinicalLongitudinalIntelligencePackageEnvelope(payload: unknown): GovernedClinicalLongitudinalIntelligencePackageResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalLongitudinalIntelligencePackageEntryView => e !== null);
