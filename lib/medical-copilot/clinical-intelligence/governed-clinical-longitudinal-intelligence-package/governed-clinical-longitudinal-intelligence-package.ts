...
export type GovernedClinicalLongitudinalIntelligencePackageEntryView = {
...
export type GovernedClinicalLongitudinalIntelligencePackageResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalLongitudinalIntelligencePackageEntryView[];
