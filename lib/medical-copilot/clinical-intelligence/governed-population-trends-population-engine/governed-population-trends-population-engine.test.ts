...
describe("Population Trends", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedPopulationTrendsPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Population Trends", applicableCount: 1,
