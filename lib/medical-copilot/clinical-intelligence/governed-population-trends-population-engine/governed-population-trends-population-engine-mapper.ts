import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPopulationTrendsPopulationEngineEntryView, type GovernedPopulationTrendsPopulationEngineResult } from "./governed-population-trends-population-engine";
function mapEntry(raw: unknown): GovernedPopulationTrendsPopulationEngineEntryView | null {
...
export function mapGovernedPopulationTrendsPopulationEngineEnvelope(payload: unknown): GovernedPopulationTrendsPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPopulationTrendsPopulationEngineEntryView => e !== null);
