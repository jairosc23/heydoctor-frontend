...
export type GovernedPopulationTrendsPopulationEngineEntryView = {
...
export type GovernedPopulationTrendsPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationTrendsPopulationEngineEntryView[];
