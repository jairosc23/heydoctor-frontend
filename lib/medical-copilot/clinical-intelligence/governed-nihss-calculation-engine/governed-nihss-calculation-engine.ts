...
export type GovernedNihssCalculationEngineEntryView = {
...
export type GovernedNihssCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedNihssCalculationEngineEntryView[]; enginesPresent: string[];
