...
export type GovernedRecommendationRankingEngineEntryView = {
...
export type GovernedRecommendationRankingEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedRecommendationRankingEngineEntryView[]; enginesPresent: string[];
