import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedResourceUtilizationPopulationEngineEntryView, type GovernedResourceUtilizationPopulationEngineResult } from "./governed-resource-utilization-population-engine";
function mapEntry(raw: unknown): GovernedResourceUtilizationPopulationEngineEntryView | null {
...
export function mapGovernedResourceUtilizationPopulationEngineEnvelope(payload: unknown): GovernedResourceUtilizationPopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedResourceUtilizationPopulationEngineEntryView => e !== null);
