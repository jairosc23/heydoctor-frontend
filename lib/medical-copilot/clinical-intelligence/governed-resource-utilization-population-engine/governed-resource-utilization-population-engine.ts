...
export type GovernedResourceUtilizationPopulationEngineEntryView = {
...
export type GovernedResourceUtilizationPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedResourceUtilizationPopulationEngineEntryView[];
