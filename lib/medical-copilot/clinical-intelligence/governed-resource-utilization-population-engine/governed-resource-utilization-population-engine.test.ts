...
describe("Resource Utilization", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedResourceUtilizationPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Resource Utilization", applicableCount: 1,
