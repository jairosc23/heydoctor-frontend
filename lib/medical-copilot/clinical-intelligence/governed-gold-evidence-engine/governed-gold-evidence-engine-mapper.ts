import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedGoldEvidenceEngineEntryView, type GovernedGoldEvidenceEngineResult } from "./governed-gold-evidence-engine";

function mapEntry(raw: unknown): GovernedGoldEvidenceEngineEntryView | null {
...
export function mapGovernedGoldEvidenceEngineEnvelope(payload: unknown): GovernedGoldEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedGoldEvidenceEngineEntryView => e !== null);
