...
export type GovernedRandomizedTrialEvidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedRandomizedTrialEvidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedRandomizedTrialEvidenceEngineEntryView[];
