...
export type GovernedClinicalTraceabilityEngineEntryView = {
...
export type GovernedClinicalTraceabilityEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalTraceabilityEngineEntryView[]; enginesPresent: string[];
