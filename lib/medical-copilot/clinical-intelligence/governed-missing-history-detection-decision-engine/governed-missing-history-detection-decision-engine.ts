...
export type GovernedMissingHistoryDetectionEngineEntryView = {
...
export type GovernedMissingHistoryDetectionEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMissingHistoryDetectionEngineEntryView[]; enginesPresent: string[];
