...
export type GovernedProcedureTimelineLongitudinalEngineEntryView = {
...
export type GovernedProcedureTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedProcedureTimelineLongitudinalEngineEntryView[];
