...
describe("Procedure Timeline", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedProcedureTimelineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Procedure Timeline", applicableCount: 1,
