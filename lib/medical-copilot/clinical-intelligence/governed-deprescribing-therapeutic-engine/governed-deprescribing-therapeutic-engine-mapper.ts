import { GOVERNED_THERAPEUTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDeprescribingTherapeuticEngineEntryView, type GovernedDeprescribingTherapeuticEngineResult } from "./governed-deprescribing-therapeutic-engine";
function mapEntry(raw: unknown): GovernedDeprescribingTherapeuticEngineEntryView | null {
...
export function mapGovernedDeprescribingTherapeuticEngineEnvelope(payload: unknown): GovernedDeprescribingTherapeuticEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDeprescribingTherapeuticEngineEntryView => e !== null);
