...
export type GovernedDeprescribingTherapeuticEngineEntryView = {
...
export type GovernedDeprescribingTherapeuticEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDeprescribingTherapeuticEngineEntryView[];
