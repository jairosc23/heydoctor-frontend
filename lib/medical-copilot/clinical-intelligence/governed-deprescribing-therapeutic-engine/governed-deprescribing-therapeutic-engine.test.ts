...
describe("Deprescribing", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDeprescribingTherapeuticEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Deprescribing", applicableCount: 1,
