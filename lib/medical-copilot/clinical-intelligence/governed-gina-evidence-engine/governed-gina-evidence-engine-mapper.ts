import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedGinaEvidenceEngineEntryView, type GovernedGinaEvidenceEngineResult } from "./governed-gina-evidence-engine";

function mapEntry(raw: unknown): GovernedGinaEvidenceEngineEntryView | null {
...
export function mapGovernedGinaEvidenceEngineEnvelope(payload: unknown): GovernedGinaEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedGinaEvidenceEngineEntryView => e !== null);
