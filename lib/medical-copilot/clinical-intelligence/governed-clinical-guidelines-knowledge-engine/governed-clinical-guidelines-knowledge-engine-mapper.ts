import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedClinicalGuidelinesKnowledgeEngineEntryView, type GovernedClinicalGuidelinesKnowledgeEngineResult } from "./governed-clinical-guidelines-knowledge-engine";

function mapEntry(raw: unknown): GovernedClinicalGuidelinesKnowledgeEngineEntryView | null {
...
export function mapGovernedClinicalGuidelinesKnowledgeEngineEnvelope(payload: unknown): GovernedClinicalGuidelinesKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalGuidelinesKnowledgeEngineEntryView => e !== null);
