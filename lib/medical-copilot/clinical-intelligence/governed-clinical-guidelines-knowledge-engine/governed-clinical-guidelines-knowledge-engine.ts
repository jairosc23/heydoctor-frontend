...
export type GovernedClinicalGuidelinesKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedClinicalGuidelinesKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedClinicalGuidelinesKnowledgeEngineEntryView[];
