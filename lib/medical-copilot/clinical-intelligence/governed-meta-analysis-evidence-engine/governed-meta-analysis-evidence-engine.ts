...
export type GovernedMetaAnalysisEvidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedMetaAnalysisEvidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedMetaAnalysisEvidenceEngineEntryView[];
