...
export type GovernedClinicalDecisionSystemPackageEntryView = {
...
export type GovernedClinicalDecisionSystemPackageResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalDecisionSystemPackageEntryView[]; enginesPresent: string[];
