...
export type GovernedRareDiseaseAwarenessDiagnosticIntelEngineEntryView = {
...
export type GovernedRareDiseaseAwarenessDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedRareDiseaseAwarenessDiagnosticIntelEngineEntryView[];
