import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedRareDiseaseAwarenessDiagnosticIntelEngineEntryView, type GovernedRareDiseaseAwarenessDiagnosticIntelEngineResult } from "./governed-rare-disease-awareness-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedRareDiseaseAwarenessDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedRareDiseaseAwarenessDiagnosticIntelEngineEnvelope(payload: unknown): GovernedRareDiseaseAwarenessDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedRareDiseaseAwarenessDiagnosticIntelEngineEntryView => e !== null);
