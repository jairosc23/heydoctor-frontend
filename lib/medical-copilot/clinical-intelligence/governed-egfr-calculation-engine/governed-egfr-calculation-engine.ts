...
export type GovernedEgfrCalculationEngineEntryView = {
...
export type GovernedEgfrCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedEgfrCalculationEngineEntryView[]; enginesPresent: string[];
