...
describe("Diagnostic Runtime", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticRuntimeDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Runtime", applicableCount: 1,
