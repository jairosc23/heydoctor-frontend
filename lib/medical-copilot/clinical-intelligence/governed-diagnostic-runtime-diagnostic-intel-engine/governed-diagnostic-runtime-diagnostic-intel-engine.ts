...
export type GovernedDiagnosticRuntimeDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticRuntimeDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticRuntimeDiagnosticIntelEngineEntryView[];
