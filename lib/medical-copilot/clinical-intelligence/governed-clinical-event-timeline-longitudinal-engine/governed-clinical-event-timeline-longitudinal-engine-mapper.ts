import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedClinicalEventTimelineLongitudinalEngineEntryView, type GovernedClinicalEventTimelineLongitudinalEngineResult } from "./governed-clinical-event-timeline-longitudinal-engine";
function mapEntry(raw: unknown): GovernedClinicalEventTimelineLongitudinalEngineEntryView | null {
...
export function mapGovernedClinicalEventTimelineLongitudinalEngineEnvelope(payload: unknown): GovernedClinicalEventTimelineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedClinicalEventTimelineLongitudinalEngineEntryView => e !== null);
