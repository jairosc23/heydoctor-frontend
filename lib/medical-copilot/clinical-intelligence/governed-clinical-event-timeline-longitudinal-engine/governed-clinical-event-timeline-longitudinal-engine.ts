...
export type GovernedClinicalEventTimelineLongitudinalEngineEntryView = {
...
export type GovernedClinicalEventTimelineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalEventTimelineLongitudinalEngineEntryView[];
