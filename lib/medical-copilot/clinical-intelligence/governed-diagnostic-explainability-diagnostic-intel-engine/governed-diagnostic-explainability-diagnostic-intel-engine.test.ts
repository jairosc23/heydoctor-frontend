...
describe("Diagnostic Explainability", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiagnosticExplainabilityDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Diagnostic Explainability", applicableCount: 1,
