import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticExplainabilityDiagnosticIntelEngineEntryView, type GovernedDiagnosticExplainabilityDiagnosticIntelEngineResult } from "./governed-diagnostic-explainability-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticExplainabilityDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticExplainabilityDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticExplainabilityDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticExplainabilityDiagnosticIntelEngineEntryView => e !== null);
