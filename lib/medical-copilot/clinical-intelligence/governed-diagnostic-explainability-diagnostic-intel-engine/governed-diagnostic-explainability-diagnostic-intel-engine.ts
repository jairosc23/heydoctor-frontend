...
export type GovernedDiagnosticExplainabilityDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticExplainabilityDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticExplainabilityDiagnosticIntelEngineEntryView[];
