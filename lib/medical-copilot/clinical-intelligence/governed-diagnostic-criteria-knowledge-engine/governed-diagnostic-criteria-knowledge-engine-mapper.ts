import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedDiagnosticCriteriaKnowledgeEngineEntryView, type GovernedDiagnosticCriteriaKnowledgeEngineResult } from "./governed-diagnostic-criteria-knowledge-engine";

function mapEntry(raw: unknown): GovernedDiagnosticCriteriaKnowledgeEngineEntryView | null {
...
export function mapGovernedDiagnosticCriteriaKnowledgeEngineEnvelope(payload: unknown): GovernedDiagnosticCriteriaKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticCriteriaKnowledgeEngineEntryView => e !== null);
