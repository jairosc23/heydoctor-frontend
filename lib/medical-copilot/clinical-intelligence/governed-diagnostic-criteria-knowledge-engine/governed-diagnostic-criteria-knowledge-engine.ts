...
export type GovernedDiagnosticCriteriaKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedDiagnosticCriteriaKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedDiagnosticCriteriaKnowledgeEngineEntryView[];
