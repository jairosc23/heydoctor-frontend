import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAdaGuidelineEngineEntryView, type GovernedAdaGuidelineEngineResult } from "./governed-ada-guideline-engine";

function mapEntry(raw: unknown): GovernedAdaGuidelineEngineEntryView | null {
...
export function mapGovernedAdaGuidelineEngineEnvelope(payload: unknown): GovernedAdaGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAdaGuidelineEngineEntryView => e !== null);
