...
export type GovernedGuidelineRecommendationEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedGuidelineRecommendationEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedGuidelineRecommendationEngineEntryView[];
