import { GOVERNED_DIAGNOSTIC_INTELLIGENCE_UI_GOVERNANCE, type GovernedDiagnosticConsistencyDiagnosticIntelEngineEntryView, type GovernedDiagnosticConsistencyDiagnosticIntelEngineResult } from "./governed-diagnostic-consistency-diagnostic-intel-engine";
function mapEntry(raw: unknown): GovernedDiagnosticConsistencyDiagnosticIntelEngineEntryView | null {
...
export function mapGovernedDiagnosticConsistencyDiagnosticIntelEngineEnvelope(payload: unknown): GovernedDiagnosticConsistencyDiagnosticIntelEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedDiagnosticConsistencyDiagnosticIntelEngineEntryView => e !== null);
