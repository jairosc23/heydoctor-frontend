...
export type GovernedDiagnosticConsistencyDiagnosticIntelEngineEntryView = {
...
export type GovernedDiagnosticConsistencyDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiagnosticConsistencyDiagnosticIntelEngineEntryView[];
