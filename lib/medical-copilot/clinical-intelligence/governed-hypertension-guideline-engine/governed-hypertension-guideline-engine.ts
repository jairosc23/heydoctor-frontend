...
export type GovernedHypertensionGuidelineEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedHypertensionGuidelineEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedHypertensionGuidelineEngineEntryView[];
