...
export type GovernedClinicalCalculationSystemPackageEntryView = {
...
export type GovernedClinicalCalculationSystemPackageResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalCalculationSystemPackageEntryView[]; enginesPresent: string[];
