...
export type GovernedEvidenceConfidenceEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedEvidenceConfidenceEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedEvidenceConfidenceEngineEntryView[];
