...
export type GovernedClinicalConsistencyEngineEntryView = {
...
export type GovernedClinicalConsistencyEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedClinicalConsistencyEngineEntryView[]; enginesPresent: string[];
