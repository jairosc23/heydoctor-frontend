import { GOVERNED_CLINICAL_GUIDELINES_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedCdcGuidelineEngineEntryView, type GovernedCdcGuidelineEngineResult } from "./governed-cdc-guideline-engine";

function mapEntry(raw: unknown): GovernedCdcGuidelineEngineEntryView | null {
...
export function mapGovernedCdcGuidelineEngineEnvelope(payload: unknown): GovernedCdcGuidelineEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedCdcGuidelineEngineEntryView => e !== null);
