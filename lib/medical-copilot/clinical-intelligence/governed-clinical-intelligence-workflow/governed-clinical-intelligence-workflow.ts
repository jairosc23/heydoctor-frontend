...
export type GovernedClinicalIntelligenceWorkflowRefView = {
...
export type GovernedClinicalWorkflowView = {
  ...
  surfaceRefs: GovernedClinicalIntelligenceWorkflowRefView[];
  currentStage: string;
  nextStage: string | null;
  completedStages: string[];
  pendingStages: string[];
};
export type GovernedClinicalIntelligenceWorkflowResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
