import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedRiskEvolutionEngineLongitudinalEngineEntryView, type GovernedRiskEvolutionEngineLongitudinalEngineResult } from "./governed-risk-evolution-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedRiskEvolutionEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedRiskEvolutionEngineLongitudinalEngineEnvelope(payload: unknown): GovernedRiskEvolutionEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedRiskEvolutionEngineLongitudinalEngineEntryView => e !== null);
