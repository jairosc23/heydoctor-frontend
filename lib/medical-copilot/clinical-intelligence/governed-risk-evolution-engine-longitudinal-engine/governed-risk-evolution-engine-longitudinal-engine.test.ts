...
describe("Risk Evolution Engine", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedRiskEvolutionEngineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Risk Evolution Engine", applicableCount: 1,
