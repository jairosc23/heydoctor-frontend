...
export type GovernedRiskEvolutionEngineLongitudinalEngineEntryView = {
...
export type GovernedRiskEvolutionEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedRiskEvolutionEngineLongitudinalEngineEntryView[];
