...
export type GovernedCalculationValidationEngineEntryView = {
...
export type GovernedCalculationValidationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCalculationValidationEngineEntryView[]; enginesPresent: string[];
