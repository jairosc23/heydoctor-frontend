...
export type GovernedPatientJourneyEngineLongitudinalEngineEntryView = {
...
export type GovernedPatientJourneyEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPatientJourneyEngineLongitudinalEngineEntryView[];
