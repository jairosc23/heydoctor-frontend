import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedPatientJourneyEngineLongitudinalEngineEntryView, type GovernedPatientJourneyEngineLongitudinalEngineResult } from "./governed-patient-journey-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedPatientJourneyEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedPatientJourneyEngineLongitudinalEngineEnvelope(payload: unknown): GovernedPatientJourneyEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPatientJourneyEngineLongitudinalEngineEntryView => e !== null);
