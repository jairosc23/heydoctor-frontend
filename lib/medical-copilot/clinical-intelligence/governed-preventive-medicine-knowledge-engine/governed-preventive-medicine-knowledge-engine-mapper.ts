import { GOVERNED_CLINICAL_KNOWLEDGE_UI_GOVERNANCE, type GovernedPreventiveMedicineKnowledgeEngineEntryView, type GovernedPreventiveMedicineKnowledgeEngineResult } from "./governed-preventive-medicine-knowledge-engine";

function mapEntry(raw: unknown): GovernedPreventiveMedicineKnowledgeEngineEntryView | null {
...
export function mapGovernedPreventiveMedicineKnowledgeEngineEnvelope(payload: unknown): GovernedPreventiveMedicineKnowledgeEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPreventiveMedicineKnowledgeEngineEntryView => e !== null);
