...
export type GovernedPreventiveMedicineKnowledgeEngineEntryView = {
  entryId: string;
  entryTitle: string;
  domain: string;
  topic: string;
...
export type GovernedPreventiveMedicineKnowledgeEngineResult = {
  payload: unknown;
  status: string | null;
  title: string | null;
  applicableCount: number;
  entries: GovernedPreventiveMedicineKnowledgeEngineEntryView[];
