...
describe("GovernedChronicDiseaseRuleEngine mapper", () => {
  it("maps deterministic rule evaluations with explainability fields", () => {
    const mapped = mapGovernedChronicDiseaseRuleEngineEnvelope({
    ...
    assert.equal(mapGovernedChronicDiseaseRuleEngineEnvelope(null), null);
  });
});
