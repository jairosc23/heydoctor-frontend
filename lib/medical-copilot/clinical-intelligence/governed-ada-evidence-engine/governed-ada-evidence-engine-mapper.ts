import { GOVERNED_CLINICAL_EVIDENCE_ENGINE_ENTERPRISE_UI_GOVERNANCE, type GovernedAdaEvidenceEngineEntryView, type GovernedAdaEvidenceEngineResult } from "./governed-ada-evidence-engine";

function mapEntry(raw: unknown): GovernedAdaEvidenceEngineEntryView | null {
...
export function mapGovernedAdaEvidenceEngineEnvelope(payload: unknown): GovernedAdaEvidenceEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedAdaEvidenceEngineEntryView => e !== null);
