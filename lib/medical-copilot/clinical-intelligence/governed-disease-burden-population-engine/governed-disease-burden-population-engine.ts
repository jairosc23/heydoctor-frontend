...
export type GovernedDiseaseBurdenPopulationEngineEntryView = {
...
export type GovernedDiseaseBurdenPopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedDiseaseBurdenPopulationEngineEntryView[];
