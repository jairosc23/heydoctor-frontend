...
describe("Disease Burden", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedDiseaseBurdenPopulationEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Disease Burden", applicableCount: 1,
