...
describe("Syndromic Recognition", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedSyndromicRecognitionDiagnosticIntelEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Syndromic Recognition", applicableCount: 1,
