...
export type GovernedSyndromicRecognitionDiagnosticIntelEngineEntryView = {
...
export type GovernedSyndromicRecognitionDiagnosticIntelEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedSyndromicRecognitionDiagnosticIntelEngineEntryView[];
