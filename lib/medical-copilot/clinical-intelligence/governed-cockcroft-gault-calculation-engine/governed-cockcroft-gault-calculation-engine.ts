...
export type GovernedCockcroftGaultCalculationEngineEntryView = {
...
export type GovernedCockcroftGaultCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCockcroftGaultCalculationEngineEntryView[]; enginesPresent: string[];
