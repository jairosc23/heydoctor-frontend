...
export type GovernedMissingImagingDetectionEngineEntryView = {
...
export type GovernedMissingImagingDetectionEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedMissingImagingDetectionEngineEntryView[]; enginesPresent: string[];
