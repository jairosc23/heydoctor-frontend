import { GOVERNED_CLINICAL_LONGITUDINAL_INTELLIGENCE_UI_GOVERNANCE, type GovernedPatientTimelineEngineLongitudinalEngineEntryView, type GovernedPatientTimelineEngineLongitudinalEngineResult } from "./governed-patient-timeline-engine-longitudinal-engine";
function mapEntry(raw: unknown): GovernedPatientTimelineEngineLongitudinalEngineEntryView | null {
...
export function mapGovernedPatientTimelineEngineLongitudinalEngineEnvelope(payload: unknown): GovernedPatientTimelineEngineLongitudinalEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPatientTimelineEngineLongitudinalEngineEntryView => e !== null);
