...
export type GovernedPatientTimelineEngineLongitudinalEngineEntryView = {
...
export type GovernedPatientTimelineEngineLongitudinalEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPatientTimelineEngineLongitudinalEngineEntryView[];
