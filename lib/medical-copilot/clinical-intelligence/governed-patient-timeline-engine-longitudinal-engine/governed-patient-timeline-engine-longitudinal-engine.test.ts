...
describe("Patient Timeline Engine", () => {
  it("maps envelope with HITL seals", () => {
    const mapped = mapGovernedPatientTimelineEngineLongitudinalEngineEnvelope({ status: "ok", data: { status: "PROPOSED_FOR_PHYSICIAN_REVIEW", title: "Patient Timeline Engine", applicableCount: 1,
