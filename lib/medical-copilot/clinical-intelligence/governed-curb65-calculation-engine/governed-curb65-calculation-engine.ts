...
export type GovernedCurb65CalculationEngineEntryView = {
...
export type GovernedCurb65CalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedCurb65CalculationEngineEntryView[]; enginesPresent: string[];
