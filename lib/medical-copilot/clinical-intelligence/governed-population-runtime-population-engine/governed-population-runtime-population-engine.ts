...
export type GovernedPopulationRuntimePopulationEngineEntryView = {
...
export type GovernedPopulationRuntimePopulationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedPopulationRuntimePopulationEngineEntryView[];
