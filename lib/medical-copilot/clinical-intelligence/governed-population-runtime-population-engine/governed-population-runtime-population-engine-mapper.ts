import { GOVERNED_POPULATION_HEALTH_UI_GOVERNANCE, type GovernedPopulationRuntimePopulationEngineEntryView, type GovernedPopulationRuntimePopulationEngineResult } from "./governed-population-runtime-population-engine";
function mapEntry(raw: unknown): GovernedPopulationRuntimePopulationEngineEntryView | null {
...
export function mapGovernedPopulationRuntimePopulationEngineEnvelope(payload: unknown): GovernedPopulationRuntimePopulationEngineResult | null {
  ...
  const entries = entriesRaw.map(mapEntry).filter((e): e is GovernedPopulationRuntimePopulationEngineEntryView => e !== null);
