...
export type GovernedNafldScoreCalculationEngineEntryView = {
...
export type GovernedNafldScoreCalculationEngineResult = {
  payload: unknown; status: string | null; title: string | null; applicableCount: number; entries: GovernedNafldScoreCalculationEngineEntryView[]; enginesPresent: string[];
