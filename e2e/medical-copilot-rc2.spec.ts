...
async function mockConsultationApis(page: import("@playwright/test").Page) {
  ...
  await page.route("**/medical-copilot/**", async (route) => {
    ...
    if (url.includes("/medical-copilot/runtime") && method === "GET") {
      await route.fulfill({
        status: 200,
        contentType: "application/json",
        body: JSON.stringify({
    ...
    if (
      (url.includes("/medical-copilot/telemetry") ||
        url.includes("/medical-copilot/feedback")) &&
      method === "POST"
    ) {
      await route.fulfill({
        status: 202,
        contentType: "application/json",
        body: JSON.stringify(facadeEnvelope({ accepted: true, scrubbedKeys: [] })),
      });
      return;
    }
    ...
    if (
      ...
      await route.fulfill({
        ...
        body: JSON.stringify(facadeEnvelope({
          ...
          diseaseKnowledgeEngine: {
            kind: "disease_knowledge_engine",
    ...
    if (
      ...
      await route.fulfill({
        ...
        body: JSON.stringify(facadeEnvelope({
          ...
          workflowCount: 1,
          workflows: [{ order: 1, workflowId: "e2e_wf_1", workflowType: "clinical_session_workflow", title: "Clinical Session Workflow", summary: "E2E workflow mock.", sourcePackages: ["medical_copilot_session"], surfaceRefs: [{ sourcePackage: "medical_copilot_session", surfaceKind: "workflow", present: true, metricLabel: "ready", metricValue: 1 }], currentStage: "ready", nextStage: null, completedStages: ["hydrate"], pendingStages: [], generatesNewClinicalContent: false, executesWorkflow: false }],
          workflowId: "e2e_wf_1",
          workflowType: "clinical_session_workflow",
          currentStage: "ready",
          nextStage: null,
          completedStages: ["hydrate"],
          pendingStages: [],
          certifiedSourcesIntegrated: ["governed_clinical_knowledge_package"],
          entryId: "e2e_clinical_ai_orchestrator_1",
          readOnly: true, executesAction: false, autoPersistedToEmr: false, draftApproved: false, writesEmr: false, repositoryInvoked: false, automaticDecision: false, usesLlm: false, generatesNewClinicalContent: false, executesWorkflow: false,
          governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false, draftApproved: false, writesEmr: false, repositoryInvoked: false, automaticDecision: false, usesLlm: false, generatesNewClinicalContent: false, executesWorkflow: false },
        })),
      });
      return;
    }
          ...
          facadeEnvelope(
            url.includes("/clinical-case-representation")
              ...
              ? {
                ...
                : url.includes("/clinical-review-timeline")
                ? { reviewTimeline: { source: "clinical_review_timeline", builderVersion: "1.0.0", reviewTimeline: { reviewTimelineId: "e2e-crt", providerId: "openai", timelineSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", physicianReviewPackageId: "gprp", validationWorkspaceId: "cvw", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-review-navigation")
                ...
                : url.includes("/physician-review-dashboard")
                ? { reviewDashboard: { source: "physician_review_dashboard", builderVersion: "1.0.0", reviewDashboard: { reviewDashboardId: "e2e-prd", providerId: "openai", dashboardSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", checklistWorkspaceId: "prcw", reviewTimelineId: "crt", reviewNavigationId: "crn", reviewSummaryId: "prs", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-review-session")
                ? { reviewSession: { source: "governed_review_session", builderVersion: "1.0.0", reviewSession: { reviewSessionId: "e2e-grs", providerId: "openai", sessionSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", physicianReviewPackageId: "gprp", checklistWorkspaceId: "prcw", reviewTimelineId: "crt", reviewNavigationId: "crn", reviewDashboardId: "prd", reviewSummaryId: "prs", validationWorkspaceId: "cvw", sessionPackageId: "gcsp", workspaceId: "w", reviewWorkspaceV2Id: "prw2", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-question-generator")
                ? { clinicalQuestions: { source: "clinical_question_generator", builderVersion: "1.0.0", clinicalQuestions: { clinicalQuestionsId: "e2e-cqg", providerId: "openai", questionSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reviewSessionId: "grs", contextId: "ctx", missingInformationId: "mie", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/physician-interview-workspace")
                ? { interviewWorkspace: { source: "physician_interview_workspace", builderVersion: "1.0.0", interviewWorkspace: { interviewWorkspaceId: "e2e-piw", providerId: "openai", interviewSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalQuestionsId: "cqg", reviewSessionId: "grs", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-completeness-analyzer")
                ...
                : url.includes("/evidence-completeness-workspace")
                ? { evidenceCompletenessWorkspace: { source: "evidence_completeness_workspace", builderVersion: "1.0.0", evidenceCompletenessWorkspace: { evidenceCompletenessWorkspaceId: "e2e-ecw", providerId: "openai", evidenceCompletenessSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", evidenceWorkspaceId: "dew", gapAnalyzerId: "dga", missingInformationId: "mie", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/physician-reasoning-preparation")
                ? { reasoningPreparation: { source: "physician_reasoning_preparation", builderVersion: "1.0.0", reasoningPreparation: { physicianReasoningPreparationId: "e2e-prp", providerId: "openai", preparationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningWorkspaceId: "crsw", differentialReviewWorkspaceId: "drw", evidenceCompletenessWorkspaceId: "ecw", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-clinical-reasoning-package")
                ? { clinicalReasoningPackage: { source: "governed_clinical_reasoning_package", builderVersion: "1.0.0", clinicalReasoningPackage: { clinicalReasoningPackageId: "e2e-gcrp", providerId: "openai", packageSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", physicianReasoningPreparationId: "prp", assessmentPackageId: "gcap", reviewSessionId: "grs", contextId: "ctx", clinicalPlanId: "plan", confidenceId: "ccf", evidenceMappingId: "emf", differentialId: "cdf", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-dataset")
                ? { clinicalReasoningDataset: { source: "clinical_reasoning_dataset", builderVersion: "1.0.0", clinicalReasoningDataset: { clinicalReasoningDatasetId: "e2e-crds", providerId: "openai", datasetSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningPackageId: "gcrp", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/evidence-correlation-workspace")
                ? { evidenceCorrelationWorkspace: { source: "evidence_correlation_workspace", builderVersion: "1.0.0", evidenceCorrelationWorkspace: { evidenceCorrelationWorkspaceId: "e2e-ecrr", providerId: "openai", correlationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningDatasetId: "crds", evidenceMappingId: "emf", evidenceWorkspaceId: "dew", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-pattern-workspace")
                ? { clinicalPatternWorkspace: { source: "clinical_pattern_workspace", builderVersion: "1.0.0", clinicalPatternWorkspace: { clinicalPatternWorkspaceId: "e2e-cpw", providerId: "openai", patternSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", evidenceCorrelationWorkspaceId: "ecrr", contextId: "ctx", clinicalPlanId: "plan", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-reasoning-workspace")
                ...
                : url.includes("/governed-clinical-reasoning-dataset")
                ? { governedClinicalReasoningDataset: { source: "governed_clinical_reasoning_dataset", builderVersion: "1.0.0", governedClinicalReasoningDataset: { governedClinicalReasoningDatasetId: "e2e-gcrd", providerId: "openai", packageDatasetSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", governedReasoningWorkspaceId: "grw", clinicalReasoningPackageId: "gcrp", reviewSessionId: "grs", assessmentPackageId: "gcap", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }

                : url.includes("/governed-clinical-reasoning-input-package")
                ? { clinicalReasoningInputPackage: { source: "governed_clinical_reasoning_input_package", builderVersion: "1.0.0", clinicalReasoningInputPackage: { clinicalReasoningInputPackageId: "e2e-gcrip", providerId: "openai", inputPackageSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", governedReasoningPreparationId: "grp", governedClinicalReasoningDatasetId: "gcrd", clinicalReasoningPackageId: "gcrp", reviewSessionId: "grs", assessmentPackageId: "gcap", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-context")
                ? { clinicalReasoningContext: { source: "clinical_reasoning_context", builderVersion: "1.0.0", clinicalReasoningContext: { clinicalReasoningContextId: "e2e-crcx", providerId: "openai", contextSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", governedClinicalReasoningDatasetId: "gcrd", contextId: "ctx", clinicalPlanId: "plan", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/evidence-graph-workspace")
                ? { evidenceGraphWorkspace: { source: "evidence_graph_workspace", builderVersion: "1.0.0", evidenceGraphWorkspace: { evidenceGraphWorkspaceId: "e2e-egw", providerId: "openai", graphSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningContextId: "crcx", evidenceCorrelationWorkspaceId: "ecrr", evidenceMappingId: "emf", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-inputs")
                ? { clinicalReasoningInputs: { source: "clinical_reasoning_inputs", builderVersion: "1.0.0", clinicalReasoningInputs: { clinicalReasoningInputsId: "e2e-cri", providerId: "openai", inputSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", evidenceGraphWorkspaceId: "egw", clinicalPatternWorkspaceId: "cpw", confidenceId: "ccf", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-reasoning-preparation")
                ? { governedReasoningPreparation: { source: "governed_reasoning_preparation", builderVersion: "1.0.0", governedReasoningPreparation: { governedReasoningPreparationId: "e2e-grp", providerId: "openai", preparationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningInputsId: "cri", governedReasoningWorkspaceId: "grw", physicianReasoningPreparationId: "prp", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-engine-foundation")
                ? { clinicalReasoningEngineFoundation: { source: "clinical_reasoning_engine_foundation", builderVersion: "1.0.0", clinicalReasoningEngineFoundation: { clinicalReasoningEngineFoundationId: "e2e-cref", providerId: "openai", foundationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", governedReasoningRuntimeId: "grrt", clinicalReasoningInputPackageId: "gcrip", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-engine-core")
                ? { clinicalReasoningEngineCore: { source: "clinical_reasoning_engine_core", builderVersion: "1.0.0", clinicalReasoningEngineCore: { clinicalReasoningEngineCoreId: "e2e-crec", providerId: "openai", engineCoreSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningInputPackageId: "gcrip", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-rule-pipeline")
                ? { reasoningRulePipeline: { source: "reasoning_rule_pipeline", builderVersion: "1.0.0", reasoningRulePipeline: { reasoningRulePipelineId: "e2e-rrp", providerId: "openai", pipelineSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningEngineCoreId: "crec", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-execution-context")
                ? { reasoningExecutionContext: { source: "reasoning_execution_context", builderVersion: "1.0.0", reasoningExecutionContext: { reasoningExecutionContextId: "e2e-rex", providerId: "openai", executionContextSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningRulePipelineId: "rrp", clinicalReasoningContextId: "crcx", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-reasoning-runtime")
                ? { governedReasoningRuntime: { source: "governed_reasoning_runtime", builderVersion: "1.0.0", governedReasoningRuntime: { governedReasoningRuntimeId: "e2e-grrt", providerId: "openai", runtimeSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningExecutionContextId: "rex", governedReasoningPreparationId: "grp", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-runtime-foundation")
                ? { clinicalReasoningRuntimeFoundation: { source: "clinical_reasoning_runtime_foundation", builderVersion: "1.0.0", clinicalReasoningRuntimeFoundation: { clinicalReasoningRuntimeFoundationId: "e2e-crrf", providerId: "openai", runtimeFoundationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", governedReasoningSessionId: "grses", clinicalReasoningEngineFoundationId: "cref", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-stage-manager")
                ? { reasoningStageManager: { source: "reasoning_stage_manager", builderVersion: "1.0.0", reasoningStageManager: { reasoningStageManagerId: "e2e-rsm", providerId: "openai", stageSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningEngineFoundationId: "cref", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-state-machine")
                ? { reasoningStateMachine: { source: "reasoning_state_machine", builderVersion: "1.0.0", reasoningStateMachine: { reasoningStateMachineId: "e2e-rstm", providerId: "openai", stateSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningStageManagerId: "rsm", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-validation-engine")
                ? { reasoningValidationEngine: { source: "reasoning_validation_engine", builderVersion: "1.0.0", reasoningValidationEngine: { reasoningValidationEngineId: "e2e-rve", providerId: "openai", validationSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningStateMachineId: "rstm", clinicalReasoningInputPackageId: "gcrip", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-reasoning-session")
                ? { governedReasoningSession: { source: "governed_reasoning_session", builderVersion: "1.0.0", governedReasoningSession: { governedReasoningSessionId: "e2e-grses", providerId: "openai", sessionSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningValidationEngineId: "rve", governedReasoningRuntimeId: "grrt", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-pipeline")
                ? { clinicalReasoningPipeline: { source: "clinical_reasoning_pipeline", builderVersion: "1.0.0", clinicalReasoningPipeline: { clinicalReasoningPipelineId: "e2e-crpl", providerId: "openai", pipelineSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningRuntimeFoundationId: "crrf", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-graph")
                ? { clinicalReasoningGraph: { source: "clinical_reasoning_graph", builderVersion: "1.0.0", clinicalReasoningGraph: { clinicalReasoningGraphId: "e2e-crg", providerId: "openai", graphSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningPipelineId: "crpl", evidenceGraphWorkspaceId: "egw", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/clinical-reasoning-trace")
                ? { clinicalReasoningTrace: { source: "clinical_reasoning_trace", builderVersion: "1.0.0", clinicalReasoningTrace: { clinicalReasoningTraceId: "e2e-crt", providerId: "openai", traceSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningGraphId: "crg", reasoningExecutionContextId: "rex", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-clinical-reasoning-session")
                ? { governedClinicalReasoningSession: { source: "governed_clinical_reasoning_session", builderVersion: "1.0.0", governedClinicalReasoningSession: { governedClinicalReasoningSessionId: "e2e-gcrs", providerId: "openai", sessionSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningTraceId: "crt", governedReasoningSessionId: "grses", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                ...
                : url.includes("/clinical-reasoning-orchestrator")
                ? { clinicalReasoningOrchestrator: { source: "clinical_reasoning_orchestrator", builderVersion: "1.0.0", clinicalReasoningOrchestrator: { clinicalReasoningOrchestratorId: "e2e-cro", providerId: "openai", orchestratorSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalReasoningPackageId: "crpkg", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/differential-reasoning-engine")
                ...
                : url.includes("/evidence-ranking-workspace")
                ? { evidenceRankingWorkspace: { source: "evidence_ranking_workspace", builderVersion: "1.0.0", evidenceRankingWorkspace: { evidenceRankingWorkspaceId: "e2e-erw", providerId: "openai", rankingSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", clinicalHypothesisWorkspaceId: "chw", evidenceReasoningEngineId: "ere", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/reasoning-quality-engine")
                ? { reasoningQualityEngine: { source: "reasoning_quality_engine", builderVersion: "1.0.0", reasoningQualityEngine: { reasoningQualityEngineId: "e2e-rqe", providerId: "openai", qualitySlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", evidenceRankingWorkspaceId: "erw", completenessId: "cca", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/physician-reasoning-review")
                ? { physicianReasoningReview: { source: "physician_reasoning_review", builderVersion: "1.0.0", physicianReasoningReview: { physicianReasoningReviewId: "e2e-prr", providerId: "openai", reviewSlots: [], governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, metadata: { sessionId: SESSION_ID, consultationId: CONSULTATION_ID, patientId: PATIENT_ID, planId: "e2e-plan", reasoningQualityEngineId: "rqe", reviewSessionId: "grs", generatedAt: new Date().toISOString(), builderVersion: "1.0.0", status: "empty", slotCount: 0, selectedProviderId: "openai" } }, governance: { requiresPhysicianReview: true, executesAction: false, autoPersistedToEmr: false }, reason: "empty", generatedAt: new Date().toISOString() } }
                : url.includes("/governed-clinical-intelligence-package")
