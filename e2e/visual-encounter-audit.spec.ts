...
test.describe("Visual audit — Clinical Encounter Hito 5", () => {
  ...
  const sections = [
    ...
    { id: "encounter-section-24", file: "clinical-decisions" },
    { id: "encounter-section-25", file: "clinical-authority" },
    { id: "encounter-section-26", file: "clinical-artifacts" },
    { id: "encounter-section-27", file: "longitudinal-records" },
    { id: "encounter-section-28", file: "clinical-rules" },
    { id: "encounter-section-29", file: "clinical-understanding" },
    { id: "encounter-section-30", file: "clinical-reasoning" },
    { id: "encounter-section-31", file: "clinical-recommendation" },
    { id: "encounter-section-32", file: "clinical-outcomes" },
    { id: "encounter-section-33", file: "clinical-governance" },
    { id: "encounter-section-34", file: "human-decision" },
    { id: "encounter-section-35", file: "clinical-execution" },
    { id: "encounter-section-36", file: "clinical-learning" },
    { id: "encounter-section-37", file: "clinical-reentry" },
    { id: "encounter-section-38", file: "clinical-knowledge" },
    { id: "encounter-section-39", file: "clinical-evidence" },
    { id: "encounter-section-40", file: "clinical-scientific-governance" },
    { id: "encounter-section-41", file: "clinical-knowledge-federation" },
    { id: "encounter-section-42", file: "clinical-knowledge-jurisdiction" },
    { id: "encounter-section-43", file: "clinical-knowledge-engine" },
    { id: "encounter-section-44", file: "clinical-knowledge-grounding" },
