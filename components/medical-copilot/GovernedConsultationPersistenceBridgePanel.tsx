...
import { useGovernedConsultationPersistenceBridge } from "@/lib/medical-copilot/clinical-intelligence/governed-consultation-persistence-bridge";
import type { GovernedConsultationPersistenceBridgeComponentPresence } from "@/lib/medical-copilot/clinical-intelligence/governed-consultation-persistence-bridge";
import { useMedicalCopilot } from "@/context/MedicalCopilotContext";

function ComponentPresenceCard({
  component,
}: {
  component: GovernedConsultationPersistenceBridgeComponentPresence;
}) {
  return (
...
export function GovernedConsultationPersistenceBridgePanel() {
  ...
  return (
    <div data-testid="governed-consultation-persistence-bridge-panel">
      <ClinicalPanel depth={2}>
        <ClinicalSection title="Governed Consultation Persistence Bridge">
          <p className="mb-3 text-xs text-slate-500">
            Primera integración controlada con Consultations · Recorre Bloques
            1–10 · Se detiene inmediatamente antes del write ·
            writeAttempted=false · repositoryInvoked=false
          </p>
          ...
          {result ? (
            <div
              className="space-y-3"
              data-testid="governed-consultation-persistence-bridge"
            >
