...
} from "@/lib/services/doctor-profiles";
...
export default function DoctorProfilePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .catch((err) => {
        setError(err instanceof Error ? err.message : "Doctor no encontrado");
      })
  ...
  if (error || !doctor) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
        <p style={{ color: "#c00", fontSize: 16 }}>{error || "Doctor no encontrado"}</p>
        <Link href="/consultar" style={{ color: TEAL, fontWeight: 600 }}>
